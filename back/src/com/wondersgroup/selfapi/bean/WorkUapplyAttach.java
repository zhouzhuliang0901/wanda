...
@Entity
@Table(name = "WORK_UAPPLY_ATTACH")
public class WorkUapplyAttach implements Serializable {
    
    /**
     * 综合材料附件
     */
    public static final String WORK_UAPPLY_ATTACH = "WORK_UAPPLY_ATTACH";
