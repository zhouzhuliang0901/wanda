...
public class UacItemInfoTwo implements Serializable {
     ...
     * 分项编码
     */
    public static final String ST_SUB_ITEM_CODE = "ST_SUB_ITEM_CODE";
    
    /**
     * 分项名称
     */
    public static final String ST_SUB_ITEM_NAME = "ST_SUB_ITEM_NAME";
     ...
     * 表单类型
     */
    public static final String NM_FTYPE = "NM_FTYPE";
     ...
     * 分项编码
     */
    @Column(name = "ST_SUB_ITEM_CODE")
    private String stSubItemCode;
     ...
     * 表单类型
     */
    @Column(name = "NM_FTYPE")
    private BigDecimal nmFtype;
     ...
     * 分项编码
     */
    public String getStSubItemCode() {
        return this.stSubItemCode;
    }
    
    /**
     * 分项编码
     */
    public String stSubItemCode2Html() {
        return StringHelper.replaceHTMLSymbol(this.stSubItemCode);
    }

    /**
     * 分项编码
     */
    public void setStSubItemCode(String stSubItemCode) {
        stSubItemCode = StringUtil.substringBySize(stSubItemCode, 50, "GB18030");
        this.stSubItemCode = stSubItemCode;
    }
     ...
     * 分项名称
     */
    public String stSubItemName2Html() {
        return StringHelper.replaceHTMLSymbol(this.stSubItemName);
    }
    ...
    public void setStSubItemName(String stSubItemName) {
        stSubItemName = StringUtil.substringBySize(stSubItemName, 200, "GB18030");
     ...
     * 表单类型
     */
    public String nmFtype2Html(int precision) {
        if (this.nmFtype == null) {
            return "";
        } else {
            String pattern = "0";
            if (precision > 0) {
            ...
            return new DecimalFormat(pattern).format(this.nmFtype);
        }
    }
     ...
     * 表单类型
     */
    public void setNmFtype(BigDecimal nmFtype) {
        this.nmFtype = nmFtype;
    }
    ...
    public void setStFurl(String stFurl) {
        stFurl = StringUtil.substringBySize(stFurl, 200, "GB18030");
        this.stFurl = stFurl;
    }
