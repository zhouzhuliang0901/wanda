...
@Entity
public class ItemsLinkItemTwo implements Serializable {
    ...
    @Transient
    @Column(name = "ST_TYPE_UI")
    private String stTypeUi;

    public String getStTypeUi() {
        return stTypeUi;
    }

    public void setStTypeUi(String stTypeUi) {
        this.stTypeUi = stTypeUi;
    }
}
