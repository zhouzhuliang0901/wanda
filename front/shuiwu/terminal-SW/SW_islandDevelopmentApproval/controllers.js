...
app.controller("matterController", function($scope, $route, $http, $location, data, $timeout) {
	...
	$scope.itemList = [{
			"stStatusName": "新办",
			"itemId": "f443fae6-3f42-4506-ad04-6790533abd26"
		},
		{
			"stStatusName": "延续",
			"itemId": "318810a9-587d-47c1-87bc-d5de40d8f0c1"
		},
		{
			"stStatusName": "依申请变更",
			"itemId": "78622314-3499-4f6a-8733-8cff1c30350f"
		}
	];
...
//		$location.path("/select");
		...
		+"&href=SW_islandDevelopmentApproval"+"&type="+$scope.type+"&deal="+$scope.deal);
	}
});
...
app.controller("riverInfo1Controller", function($scope, $route, $http, $location, data, $timeout) {
	...
	if(data.statusName == "新办"){
		data.itemCode = "310101242000-03";
	}else if(data.statusName == "延续"){
		data.itemCode = "310101242000-02";
	}else{
		data.itemCode = "310101242000-01";
	}
	if(data.itemCode) {
		$.ajax({
				type: "get",
	...
	// 用岛范围
	$scope.YDFW = YDFW;
	$scope.selected_ydfw = $scope.YDFW[0];
	...
	$scope.goNext = function() {
		...
		var info = {
			...
			"mdata": "",
			"YDFW": {
				"name": $scope.selected_ydfw.name,
				"value": $scope.selected_ydfw.value
			},
			"userType": "法人",
			"ST_ORG_TYPE": {
			...
			"PROJECTMONEY": $scope.PROJECTMONEY,
			"mobile": $scope.mobile,
			"stuff2158": [],
			"stuff19n00245": [],
			"stuff2160": [],
