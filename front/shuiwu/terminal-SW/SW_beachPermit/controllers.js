...
app.controller("matterController", function($scope, $route, $http, $location, data, $timeout) {
	...
	$scope.itemList = [{
			"stStatusName": "新办",
			"itemId": "682972ff-1813-4b56-87d3-912b6a2dee01"
		},
		{
			"stStatusName": "补证",
			"itemId": "7bc0a86e-77d2-48f1-bd87-f6d667f4291f"
		},
		{
			"stStatusName": "依申请变更",
			"itemId": "84f9a85d-ee26-4a96-992e-6cad39c21d8e"
		}
	];
...
//		$location.path("/select");
		...
		+"&href=SW_beachPermit"+"&type="+$scope.type+"&deal="+$scope.deal);
	}
});
...
app.controller("riverInfo1Controller", function($scope, $route, $http, $location, data, $timeout) {
	...
	if(data.statusName == "新办"){
		data.itemCode = "310100520000-02";
	}else if(data.statusName == "补证"){
		data.itemCode = "310100520000-01";
	}else{
		data.itemCode = "310100520000-03";
	}
	if(data.itemCode) {
		$.ajax({
				type: "get",
	...
	$scope.goNext = function() {
		...
		var info = {
			"PROJECTUSEFULL": $scope.PROJECTUSEFULL,
			...
			"mdata": "",
			"userType": "法人",
			...
			"DEVELOPRANGE": $scope.DEVELOPRANGE,
			...
			"DEVELOPLIMIT": $scope.DEVELOPLIMIT,
