...
app.controller("matterController", function($scope, $route, $http, $location, data, $timeout) {
	...
	$scope.totalPages = 1;
	$scope.itemList = [
		{"stStatusName":"新办","itemId":"7af63e61-bf42-455a-982d-2332a9f345f9","index":1},
		{"stStatusName":"延续","itemId":"7ca32548-b736-44fa-99bb-e379b6abbdf4","index":2},
		{"stStatusName":"依申请变更","itemId":"bec26ada-959e-4630-8805-a1071bf48bcc","index":3},
	];
...
//	$scope.getSearchMatter();
	...
	$scope.getSubItem = function(statusName,itemId,index) {
		...
		data.statusIndex = statusName == "依申请变更" ? 2 : 1;
...
//		$location.path("/select");
		...
		+"&href=SW_approvalOfTreeMigration"+"&type="+$scope.type+"&itemIndex="+$scope.itemIndex
		+"&deal="+$scope.deal);
	}
});
...
app.controller("riverInfo1Controller", function($scope, $route, $http, $location, data, $timeout) {
	...
	data.itemCode = "310100535000-0" + data.itemIndex
	if(data.itemCode) {
		$.ajax({
				type: "get",
	...
	$scope.goNext = function() {
		...
		var info = {
			...
			"mdata": "",
			"userType": "法人",
			"ST_ORG_TYPE": {
