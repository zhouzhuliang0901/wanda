app.controller("mainController", function ($scope, $route, $location, $http, data, $timeout) {
    $scope.currentPage = 1;
    $scope.formList = [{
            imgUrl: "../libs/common/images/yangbiao/Contactinformation.png",
            formName: "联络员信息",
            paste: true
        },
        {
            imgUrl: "../libs/common/images/yangbiao/cwfzr.jpg",
            formName: "财务负责人信息",
            paste: true
        },
        {
            imgUrl: "../libs/common/images/yangbiao/dsjsjl.jpg",
            formName: "董事、监事、经理信息",
            paste: true
        },
        {
            imgUrl: "../libs/common/images/yangbiao/fddbr.jpg",
            formName: "法定代表人信息",
            paste: true
        },
        {
            imgUrl: "../libs/common/images/yangbiao/dszn.png",
