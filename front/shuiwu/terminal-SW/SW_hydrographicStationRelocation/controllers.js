...
app.controller("matterController", function($scope, $route, $http, $location, data, $timeout) {
	...
	$scope.itemList = [{
			"stStatusName": "新办",
			"itemId": "9e57cbda-024b-4b85-a5fb-43ae85e314fb"
		},
		{
			"stStatusName": "变更",
			"itemId": "8d7ed937-27e1-4230-9a1a-ac0a3f145795"
		}
	];
...
//		$location.path("/select");
		...
		+"&href=SW_hydrographicStationRelocation"+"&type="+$scope.type+"&deal="+$scope.deal);
	}
});
...
app.controller("riverInfo1Controller", function($scope, $route, $http, $location, data, $timeout) {
	...
	$scope.goNext = function() {
		...
		var info = {
			...
			"expId": "",
			"stuff19n10716": [],
			"APPLICATIONCONTENT": $scope.APPLIER,
			"DISTRICTS": {
			...
			"targetName": $scope.APPLIER,
			"mdata": "",
			"userType": "法人",
			"ST_ORG_TYPE": {
			...
			"COMPANYCODE": $scope.APPLIER,
			"ARTMPHONE": $scope.APPLIER,
			"userId": "",
			"LINKFAX": $scope.APPLIER,
			"licenseType": {
				"name": "身份证",
				"value": "a"
			},
			"APPADDRESS": $scope.APPLIER,
			"ST_LINK_NAME": $scope.APPLIER,
			"LINKEMAIL": $scope.APPLIER,
			"ARTIFICIALPERSON": $scope.APPLIER,
			"INVOLVEDRIVER": $scope.APPLIER,
			"DWTEL": $scope.APPLIER,
			"OLDADDRESS": $scope.APPLIER,
			"ARTFAX": $scope.APPLIER,
			"stuff19n10769": [],
			"NEWADDRESS": $scope.APPLIER,
			"LINKMAN": $scope.APPLIER,
			"LINKMOBILEPHONE": $scope.APPLIER,
			"ARTPHONE": $scope.APPLIER,
			"ST_LINK_ADDRESS": $scope.APPLIER,
			"stuffPreFill": {
				"cert": {},
				"img": {}
			},
			"stuff2275": [],
			"APPPOST": $scope.APPLIER,
			"mobile": $scope.APPLIER
		};
		var fConfig = {
...
app.controller("riverInfo2Controller", function($scope, $route, $http, $location, data, $timeout) {
	...
	$scope.goNext = function() {
		...
		var info = {
			...
			"mdata": "",
			"userType": "个人",
			"ST_ORG_TYPE": {
				"name": "企业",
				"value": "a"
			...
			"INVOLVEDRIVER": $scope.INVOLVEDRIVER,
			"DWTEL": $scope.DWTEL,
