...
app.controller("guidelineController", function($scope, $route, $http, $location, data, $timeout) {
	...
	data.listImg = [];
	data.fileName = [];
	data.itemName = "向国际组织、外国的组织或个人提供海洋观测资料和成果的审批";
	$scope.guideTitle = data.itemName;
	data.itemId = "5cbf2956-6013-4246-bbfc-f1f06e113eec";// 获取相对应的办事指南
...
//		$location.path("/select");
		...
		+"&href=SW_marineObservation"+"&type="+data.type+"&deal="+data.deal);
	}
});
...
app.controller("infoController", function($scope, $route, $http, $location, data, $timeout) {
	...
	$scope.goNext = function() {
		...
		var info =  {
					...
					"mdata": "",
					"userType": "法人",
					"ST_ORG_TYPE": {
					...
					"DWTEL": $scope.DWTEL,
					"TGDX": $scope.TGDX,
					"ZLCGMCJXZ": $scope.ZLCGMCJXZ,
					"ARTFAX": $scope.ARTFAX,
					"LINKTELPHONE": $scope.LINKTELPHONE,
