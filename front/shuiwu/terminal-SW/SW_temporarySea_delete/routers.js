...
//      .when('/riverInfo1',{templateUrl:'views/riverInfo/info01.html', controller:'riverInfo1Controller'})
//      .when('/riverInfo2',{templateUrl:'views/riverInfo/info02.html', controller:'riverInfo2Controller'})
        ...
        .when('/infoFinish1',{templateUrl:'views/infoFinish1.html', controller:'infoFinishController'})
        // 法人
        .when('/key', {
        ...
        .otherwise({redirectTo:'/guideline'})
}]);