...
//themeController
app.controller('themeController', function($scope, $route, $location, $http, data) {
...
app.controller("detailController", function($scope, $route, $location, $http, data, $routeParams, $rootScope) {
	...
	$scope.back = function() {
		$location.path($rootScope.prevRouteName)
	}
});
//错误页面控制器
