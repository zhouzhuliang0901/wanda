app.controller("guidelineJygxController", function($scope, $route, $http, $location, $rootScope,$sce, data, $timeout,appFactory) {
	...
	$scope.guideInfo = {
		clName: "<p>办理跨省异地就医登记备案 </p >", //事项名称
		clDept: "市医保局", //主管部门
		clApplyConds: "就医关系已转移至外省市的本市城保、居保人员", //申报条件
		clApprovalMater: "<p>申请对象需带齐以下材料原件：</p ><p>&nbsp;&nbsp;1、	有效身份证；</p ><p>&nbsp;&nbsp;2、	社保卡或医疗卡；</p ><p>&nbsp;&nbsp;3、	委托他人办理，还需提供被委托人有效身份证。</p >",
		clApprovalProcess: "<p>1、该项业务全市通办，申请对象携带相关材料至就近的区县医保中心或就近的街(镇)社区事务受理服务中心办理；</p ><p>2、材料齐全，无特殊情况当场办结；</p ><p>3、上海市医疗保险咨询热线：962218。", // 办理流程</p >, // 办理流程
		clChargeStd: "<p>免费</p >"
	};
		...
		$scope.next = function(){
			var manIdcard = $.ajax({
				...
				success:function(dataJsonp){
					...
					setSelectCheckedByText("nations", dataJsonp.SETHNIC+'族');
					$timeout(function(){
						$scope.next1();
					},300);
				},error:function(err){
