...
//				data.idCardName = "毛雅璐"//"邹天奇"; //"王梅华"; //
//				data.idCardNum = "350722199011260084";//"430426199804106174"; //"310109194911262065"; //"310104197308010412"; //""; //"";//"320831199503150013";//"310105197805313613"; //
...
app.controller("infoFinishController", function($scope, $route, $http, $location, $rootScope, data, $timeout, appFactory) {
					...
					$scope.finishData = {
						...
						ywtbAffairsapply: {
							...
							formdata: [{
								...
								"regAddrCode": data.hjAddress.nbd,
								...
								"resaddrcode": data.jzAddress.liveNbd,
								...
								"spouseregaddrcode": data.mhjAddress.nbd,
								...
								"spouseresaddrcode": data.mjzAddress.liveNbd,
								...
								"display": {
									...
									"配偶户籍居委": data.mhjAddressName.nbd,
									...
									"配偶居住居委": data.mjzAddressName.liveNbd,
	...
	$scope.print = function() {
		...
		if(data.itemName == "跨省异地就医登记备案") {
			lodop.ADD_PRINT_TEXT(190, 165, 600, 50, "上海市政务服务       告知单");
		} else {
		...
		lodop.SET_PRINT_STYLEA(0, "FontName", "仿宋");
		if(data.itemName == "跨省异地就医登记备案") {
			lodop.ADD_PRINT_TEXT(330, 65, 700, 30, "您已成功办理就医关系转移、跨省异地就医登记备案相关手续申请2项事项");
			lodop.SET_PRINT_STYLEA(0, "FontName", "仿宋");
			lodop.SET_PRINT_STYLEA(0, "FontSize", 14);
		} else if(data.itemName == "生育保险") {
		...
		if(data.itemName == "就业补贴") {
			...
			lodop.ADD_PRINT_TABLE(700, 50, 700, 1000, "<style>table{font-family:'FangSong'}table td{border:1px solid} tr td:nth-child(1){text-align:center}tr td:nth-child(2){padding-left:20px;}tr td:nth-child(3){padding-left:20px;} table th{border:1px solid} table{border-collapse: collapse}</style><table><tr><th style='width:60px'>序号</th><th style='width:300px'>申请材料</th><th style='width:250px'>材料来源</th></tr><tr><td>1</td><td>女方居民身份证</td><td>电子文件/纸质</td></tr><tr><td>2</td><td>男方居民身份证</td><td>电子文件</td></tr><tr><td>3</td><td>女方户籍证明</td><td>电子文件</td></tr><tr><td>4</td><td>男方户籍证明</td><td>电子文件</td></tr><tr><td>5</td><td>生育医学证明</td><td>原件</td></tr><tr><td>6</td><td>银行卡</td><td>电子文件</td></tr></table>");
		} else if(data.itemName == "跨省异地就医登记备案") {
