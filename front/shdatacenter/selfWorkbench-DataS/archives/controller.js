...
app.controller("guideline", function($scope, $state, appData, appFactory, $http, $timeout, $rootScope) {
	...
	if($scope.stuffName == "涉外婚姻登记档案查询") {
		$scope.info = "<p>1、主管部门：市档案局</p>" +
			...
			"<p>5、查档须知：</p>" +
			"<p>（1）该服务仅限本人申请查询；</p>" +
			"<p>（2）各档案馆在线审核时间为<span style='color:#e1ba1c;font-weight:bold;'>周一至周六8:30-16:30，周日及国定节假日8:30～11:30</span>；</p>" +
			"<p>（3）目前仅提供由市、区综合档案馆接收和保存的相关民生档案；</p>" +
			"<p>（4）申请人获取的档案复制件及其相关档案信息，未经保管档案的档案馆同意，不得擅自向社会公布，或用以从事法律法规禁止的其他行为。</p>";
	} else {
		$scope.info = "<p>1、主管部门：市档案局</p>" +
			"<p>2、申报条件：" + $scope.guideline + "</p>" +
