app.controller("formMain", function($scope, $state, appData, appFactory) {
	...
	$scope.takeFormList = [{
			formName: "消防安全检查申报表",
			formImg: "../libs/common/images/autoForm/xfaq.png"
		},
		{
			formName: "公共场所卫生许可证申请表",
			formImg: "../libs/common/images/autoForm/ggcs.png"
		},
		{
			formName: "户外招牌设置申请表",
			formImg: "../libs/common/images/autoForm/hwzp.png"
		},
		{
			formName: "酒类商品零售许可证申请表",
			formImg: "../libs/common/images/autoForm/jlspls.png"
		},
		{
			formName: "《娱乐经营许可证》申请表",
			formImg: "../libs/common/images/autoForm/yljyxk.png"
		},
		{
			formName: "印刷企业设立备案表",
			formImg: "../libs/common/images/autoForm/ysqy.png"
		}
//		,
//		{
//			formName: "上海市城市建设档案利用规定",
//			formImg: "../libs/common/images/autoForm/jsda.png"
//		}
		//		{
		//			formName: "联络员信息",
...
app.controller("formPrint", function($scope, $state, appData, appFactory, $timeout) {
	...
	$scope.getForm = function() {
		...
		$timeout(function() {
			layer.close(index2);
			$.device.officeShow(950, 800, 240, 165);
		}, 4000);
		$timeout(function() {
