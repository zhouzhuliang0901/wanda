app.config(function ($urlRouterProvider, $stateProvider) {
    ...
    $stateProvider
        ...
        .state("chooseform", {//选择本人，还是代办
            url: "/chooseform",
            templateUrl: "views/chooseform.html",
            controller: "chooseformController"
        })
        .state("brushcard", {//代办登录 刷本人身份证
            url: "/brushcard",
            templateUrl: "views/brushcard.html",
            controller: "brushcardController"
        })
         .state("saveDeviceInfo", {//保存设备信息
            url: "/saveDeviceInfo",
            templateUrl: "views/saveDeviceInfo.html",
            controller: "saveDeviceInfoController"
        })
})