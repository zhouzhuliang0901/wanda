! function($) {
	 ...
	 * @private
	 */
	UrlRouter.prototype._init = function() {
		...
		if(currentUrlObj.fragment && currentUrlObj.fragment != '/main') {
	 ...
	 */
	UrlRouter.prototype.load = function(url, ignoreCache) {
	 ...
	 * 调用 history.forward()
	 */
	UrlRouter.prototype.forward = function() {
		theHistory.forward();
	};
	 ...
	 * 调用 history.back()
	 */
	UrlRouter.prototype.back = function() {
		theHistory.back();
	};
	 ...
	 * @deprecated
	 */
	UrlRouter.prototype.loadPage = UrlRouter.prototype.load;
	 ...
	 * @private
	 */
	UrlRouter.prototype._switchToSection = function(sectionId) {
		if(!sectionId) {
			return;
		}
	 ...
	 * @private
	 */
	UrlRouter.prototype._switchToDocument = function(url, ignoreCache, isPushState, direction) {
	 ...
	 * @private
	 */
	UrlRouter.prototype._doSwitchDocument = function(url, isPushState, direction) {
	 ...
	 * @private
	 */
	UrlRouter.prototype._isTheSameDocument = function(url, anotherUrl) {
	 ...
	 * @private
	 */
	UrlRouter.prototype._loadDocument = function(url, callback) {
	 ...
	 * @private
	 */
	UrlRouter.prototype._parseDocument = function(url, $doc) {
	 ...
	 * @private
	 */
	UrlRouter.prototype._saveDocumentIntoCache = function(doc, url) {
	 ...
	 * @private
	 */
	UrlRouter.prototype._getLastState = function() {
	 ...
	 * @private
	 */
	UrlRouter.prototype._saveAsCurrentState = function(state) {
	 ...
	 * @private
	 */
	UrlRouter.prototype._getNextStateId = function() {
	 ...
	 * @private
	 */
	UrlRouter.prototype._incMaxStateId = function() {
	 ...
	 * @private
	 */
	UrlRouter.prototype._animateDocument = function($from, $to, $visibleSection, direction) {
	 ...
	 * @private
	 */
	UrlRouter.prototype._animateSection = function($from, $to, direction) {
		var toId = $to.attr('id');
	 ...
	 * @private
	 */
	UrlRouter.prototype._animateElement = function($from, $to, direction) {
	 ...
	 * @private
	 */
	UrlRouter.prototype._getCurrentSection = function() {
	 ...
	 * @private
	 */
	UrlRouter.prototype._back = function(state, fromState) {
	 ...
	 * @private
	 */
	UrlRouter.prototype._forward = function(state, fromState) {
		if(this._isTheSameDocument(state.url.full, fromState.url.full)) {
			var $newPage = $('#' + state.pageId);
			if($newPage.length) {
				var $currentPage = this._getCurrentSection();
	 ...
	 * @private
	 */
	UrlRouter.prototype._onPopState = function(event) {
	 ...
	 * @private
	 */
	UrlRouter.prototype._pushNewState = function(url, sectionId) {
		var state = {
			id: this._getNextStateId(),
			pageId: sectionId,
	 ...
	 * @private
	 */
	UrlRouter.prototype._generateRandomId = function() {
		return "page-" + (+new Date());
	};

	UrlRouter.prototype.dispatch = function(event) {
