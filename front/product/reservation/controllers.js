//1
app.controller('onecontroller', function($scope, $location, instance, appFactory, $timeout, $http) {
	...
	$scope.getDepartment = function() { //获取部
		$timeout(function() {
			appFactory.r_pro_fetch("/reservations/getOrgans", {
//				fmd: 'aci-reservation',
//				fdo: 'getAllOrgans',
				dept: ''
			}, function(data) {
...
//			appFactory.pro_fetch("forward.do", {
			appFactory.r_pro_fetch("/reservations/getAllItemsByOrganId", {
//				fmd: 'aci-reservation',
//				fdo: 'getAllItemsByOrganId',
	...
	$scope.searchs = function(val) {
		...
		$timeout(function() {
//			appFactory.pro_fetch("forward.do", {
			appFactory.r_pro_fetch("/reservations/getAllItemsByItemName", {
//				fmd: 'aci-reservation',
...
//			appFactory.pro_fetch("forward.do", { //获取可预约日期
			appFactory.r_pro_fetch("/reservations/getReservationAllDay", { //获取可预约日期
//				fmd: 'aci-reservation',
...
//		appFactory.pro_fetch("forward.do", {
		appFactory.r_pro_fetch("/reservations/getReservationAllTime", {
//			fmd: 'aci-reservation',
...
//			appFactory.pro_fetch("forward.do", { //发送预约
			appFactory.r_pro_fetch("/reservations/saveReservationInfo", { //发送预约
//				fmd: 'aci-reservation',
