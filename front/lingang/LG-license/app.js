...
app.factory("appConfig", function($http, $interval, $location,$rootScope) {
	var data = {};
	//var $ConfigUrl = "http://192.168.1.142:8080/ac-product/aci/certification/"; //证照柜测试接口地址
	var $ConfigUrl = "http://172.16.6.18:8080/aci/certification/"; //证照柜接口地址
	//柜子标识
	var $stMachineId = "A";
	var _timer = null;
...
// 		}
	...
	var preUrl = "http://172.16.6.18:8080";
	var getResideQuantity = function() {
		
		_http("queryCertIficationInfo.do", {ST_CERT_IFICATION_TYPE:"1"}, function(res) {
			$rootScope.resideQuantity = 60 - res.length;
