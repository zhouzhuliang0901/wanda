...
app.controller("guideline", function($scope, $state, appData, appFactory, $http, $timeout, $rootScope) {
	...
	//	console.log(perjsonStr[8]);
	//	appData.id =perjsonStr[8].id;
	//	appData.code =perjsonStr[8].code;
	//	appData.type = "handle";
	//	appData.stuffName =perjsonStr[8].stuffName;
	//	appData.guideline =perjsonStr[8].guideline;
	//	appData.API_ID = {
	//			"A": perjsonStr[8].API_ID_A,
	//			"B": perjsonStr[8].API_ID_B,
	//			"C": perjsonStr[8].API_ID_C,
	//			"D": perjsonStr[8].API_ID_D,
	//		};
	removeAnimate($('.main2'));
