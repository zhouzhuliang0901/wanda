...
//	console.log(perjsonStr[1]);
//	appData.id =perjsonStr[1].id;
//	appData.code =perjsonStr[1].code;
//	appData.type = "handle";
//	appData.stuffName =perjsonStr[1].stuffName;
//	appData.guideline =perjsonStr[1].guideline;
//	appData.API_ID = {
//			"A": perjsonStr[1].API_ID_A,
//			"B": perjsonStr[1].API_ID_B,
//			"C": perjsonStr[1].API_ID_C,
//			"D": perjsonStr[1].API_ID_D,
//		};
	removeAnimate($('.main2'));
