...
//	console.log(perjsonStr[14]);
//	appData.id =perjsonStr[14].id;
//	appData.code =perjsonStr[14].code;
//	appData.type = "handle";
//	appData.stuffName =perjsonStr[14].stuffName;
//	appData.guideline =perjsonStr[14].guideline;
//	appData.API_ID = {
//			"A": perjsonStr[14].API_ID_A,
//			"B": perjsonStr[14].API_ID_B,
//			"C": perjsonStr[14].API_ID_C,
//			"D": perjsonStr[14].API_ID_D,
//		};
	removeAnimate($('.main2'));
...
app.controller('archivesLoginType', function($state, $scope, appData, $http) {
	...
	$scope.choice = function() {
		...
		} else if($scope.stuffName == "专业技术干部的农村家属迁往城镇审批档案查询") {
