	...
	$timeout(function() {
		$scope.$watch("medicinetype", function(val) {
			if(val) {
				...
				$scope.bigType = changeListname($scope.bigType, 'value')
			}
		});
		$scope.$watch("bigtype", function(val) {
			if(val) {
				...
				$scope.middleType = changeListname($scope.middleType, 'value')
			}
		});
		$scope.$watch("middletype", function(val) {
			if(val) {
				...
				$scope.smallType = changeListname($scope.smallType, 'value')
			}
		});
