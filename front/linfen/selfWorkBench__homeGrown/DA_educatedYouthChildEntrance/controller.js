...
app.controller("guideline", function($scope, $state, appData, appFactory, $http, $timeout, $rootScope) {
	...
	//	console.log(perjsonStr[2]);
	//	appData.id =perjsonStr[2].id;
	//	appData.code =perjsonStr[2].code;
	//	appData.type = "handle";
	//	appData.stuffName =perjsonStr[2].stuffName;
	//	appData.guideline =perjsonStr[2].guideline;
	//	appData.API_ID = {
	//			"A": perjsonStr[2].API_ID_A,
	//			"B": perjsonStr[2].API_ID_B,
	//			"C": perjsonStr[2].API_ID_C,
	//			"D": perjsonStr[2].API_ID_D,
	//		};
	removeAnimate($('.main2'));
