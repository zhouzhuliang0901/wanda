...
app.controller("info", function($scope, $state, appData, $sce, appFactory) {
	...
	$scope.lose = function() {
		...
		recordUsingHistory('医保服务', '办理', "办理医疗卡书面挂失及撤销", appData.licenseName, appData.licenseNumber, $scope.consignerMobile, "", JSON.stringify($scope.jsonStr));
	...
	$scope.revoke = function() {
		...
		trackEventForAffairs('办理医疗卡撤销','办理','上海市医疗保障局',appData.licenseName,appData.licenseNumber,$scope.consignerMobile)
	}
