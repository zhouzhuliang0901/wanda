...
//	console.log(perjsonStr[3]);
//	appData.id =perjsonStr[3].id;
//	appData.code =perjsonStr[3].code;
//	appData.type = "handle";
//	appData.stuffName =perjsonStr[3].stuffName;
//	appData.guideline =perjsonStr[3].guideline;
//	appData.API_ID = {
//			"A": perjsonStr[3].API_ID_A,
//			"B": perjsonStr[3].API_ID_B,
//			"C": perjsonStr[3].API_ID_C,
//			"D": perjsonStr[3].API_ID_D,
//		};
	removeAnimate($('.main2'));
