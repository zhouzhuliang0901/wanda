...
function WdatePickerDate() {
	WdatePicker();
}

function WdatePickerDateAndTime() {
	WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'});
}

function WdatePickerDateAndHourMinute() {
	WdatePicker({dateFmt:'yyyy-MM-dd HH:mm'});
}

function WdatePickerDateAndHour() {
	WdatePicker({dateFmt:'yyyy-MM-dd HH'});
}

function WdatePickerTime() {
	WdatePicker({dateFmt:'HH:mm:ss'});
}

function WdatePickerStartNowDate() {
	WdatePicker({minDate:'%y-%M-%d'});
}

function WdatePickerEndNowDate() {
	WdatePicker({maxDate:'%y-%M-%d'});
}

function WdatePickerDateFmt(dateFmt) {
	var sDate = {};
	sDate.dateFmt = dateFmt;
	WdatePicker(sDate);
}

function WdatePickerRangeDate(startDate, endDate) {
	var sDate = {};
	sDate.minDate = startDate;
	sDate.maxDate = endDate;
	WdatePicker(sDate);
}