...
//	console.log(perjsonStr[6]);
//	appData.id =perjsonStr[6].id;
//	appData.code =perjsonStr[6].code;
//	appData.type = "handle";
//	appData.stuffName =perjsonStr[6].stuffName;
//	appData.guideline =perjsonStr[6].guideline;
//	appData.API_ID = {
//			"A": perjsonStr[6].API_ID_A,
//			"B": perjsonStr[6].API_ID_B,
//			"C": perjsonStr[6].API_ID_C,
//			"D": perjsonStr[6].API_ID_D,
//		};
	removeAnimate($('.main2'));
