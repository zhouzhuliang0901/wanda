...
//	console.log(perjsonStr[9]);
//	appData.id =perjsonStr[9].id;
//	appData.code =perjsonStr[9].code;
//	appData.type = "handle";
//	appData.stuffName =perjsonStr[9].stuffName;
//	appData.guideline =perjsonStr[9].guideline;
//	appData.API_ID = {
//			"A": perjsonStr[9].API_ID_A,
//			"B": perjsonStr[9].API_ID_B,
//			"C": perjsonStr[9].API_ID_C,
//			"D": perjsonStr[9].API_ID_D,
//		};
	removeAnimate($('.main2'));
