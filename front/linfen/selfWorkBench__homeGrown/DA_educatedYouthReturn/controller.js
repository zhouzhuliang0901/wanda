...
//	console.log(perjsonStr[4]);
//	appData.id =perjsonStr[4].id;
//	appData.code =perjsonStr[4].code;
//	appData.type = "handle";
//	appData.stuffName =perjsonStr[4].stuffName;
//	appData.guideline =perjsonStr[4].guideline;
//	appData.API_ID = {
//			"A": perjsonStr[4].API_ID_A,
//			"B": perjsonStr[4].API_ID_B,
//			"C": perjsonStr[4].API_ID_C,
//			"D": perjsonStr[4].API_ID_D,
//		};
	removeAnimate($('.main2'));
