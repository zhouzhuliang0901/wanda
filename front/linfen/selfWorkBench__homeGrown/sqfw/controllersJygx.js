app.controller("guidelineJygxController", function($scope, $route, $http, $location, $rootScope, $sce, data, $timeout,
	...
	trackEvent("异地就医一件事（办理就医关系转移+跨省异地就医登记备案相关手续）", "31LB00004000");
	...
	$scope.print = function() {
		$scope.isAlert = true;
		$scope.msg = "正在打印...";
		var Html="<style>dl{margin-left: 50px;} dd{width:620px;} dt{font-weight:bold}</style><body>" +
		    "<h1 style='margin:50px auto 20px;width: 620px;text-align: center;'>办事指南</h1>"+
