...
//	console.log(perjsonStr[5]);
//	appData.id =perjsonStr[5].id;
//	appData.code =perjsonStr[5].code;
//	appData.type = "handle";
//	appData.stuffName =perjsonStr[5].stuffName;
//	appData.guideline =perjsonStr[5].guideline;
//	appData.API_ID = {
//			"A": perjsonStr[5].API_ID_A,
//			"B": perjsonStr[5].API_ID_B,
//			"C": perjsonStr[5].API_ID_C,
//			"D": perjsonStr[5].API_ID_D,
//		};
	removeAnimate($('.main2'));
