...
app.controller('info', function($state, $scope, appData, $location, appFactory, $timeout, $rootScope) {
	...
	$scope.nationList = changeListname(nations, 'shortname');
	...
	$scope.hjCityList2=changeListname($scope.hjCityList, 'value');
	$scope.jzCityList = filterByName($rootScope.allList, '310000');
	$scope.jzCityList2=changeListname($scope.jzCityList,'value');
