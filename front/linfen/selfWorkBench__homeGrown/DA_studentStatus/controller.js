...
//	console.log(perjsonStr[7]);
//	appData.id =perjsonStr[7].id;
//	appData.code =perjsonStr[7].code;
//	appData.type = "handle";
//	appData.stuffName =perjsonStr[7].stuffName;
//	appData.guideline =perjsonStr[7].guideline;
//	appData.API_ID = {
//			"A": perjsonStr[7].API_ID_A,
//			"B": perjsonStr[7].API_ID_B,
//			"C": perjsonStr[7].API_ID_C,
//			"D": perjsonStr[7].API_ID_D,
//		};
	removeAnimate($('.main2'));
