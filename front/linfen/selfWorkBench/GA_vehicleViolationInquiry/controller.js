...
//			appData.licenseNumber = "410183199503102011"; //"350722199011260084" //;"
//			appData.licenseName = "于艳娟"; //"毛雅璐" //;
//			appData.VALIDSTARTDAY = "2011-06-03";
//			appData.VALIDENDDAY = "2021-06-03";
//			$scope.nextStep();
//		}
//		$scope.idcardLogin()
...
app.controller("info", function($scope, $state, appData, $sce, appFactory, $timeout) {
	...
	$scope.driverLicense = function() {
		let nConfig = {
			identNo: appData.encrypt_identity || $scope.licenseNumber, //data.idCardNum,
...
//				if(dataJsonp.success == true) {
					$scope.driverLicenseInfo = dataJsonp;
					//清分周期
					$scope.qfrq = year + "" + dataJsonp.MAKEDAY.split(" ")[0].substring(4, 10);
...
//				}
		...
		$.ajax({
			...
			data: {
				...
				catMainCode: "310100208000100",
				machineId: $.config.get('uniqueId') || "68-ED-A4-35-C9-28",
				use: encodeURI('证照查看'),
				name: encodeURI($scope.licenseName),
				startDay: appData.VALIDSTARTDAY,
				endDay: appData.VALIDENDDAY,
