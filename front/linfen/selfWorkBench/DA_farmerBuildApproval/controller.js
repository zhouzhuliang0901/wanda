...
app.controller("guideline", function($scope, $state, appData, appFactory, $http, $timeout, $rootScope) {
	...
	$scope.prevStep = function() {
		window.location.href = "../archives/index.html"
	}
...
app.controller("info", function($scope, $state, appData, appFactory, $http, $timeout, $rootScope) {
	...
	$scope.nextStep = function() {
		...
		$scope.param = {
			...
			"query": {
				...
				"condition_detail": { //查询条件
					"Q_LIKE_HOUSE_HOLDER": appData.submitInfo.stName,
					"Q_LIKE_HOME_ADDRESS": appData.submitInfo.stAddress,
		...
		//				"ssdagmc": "崇明档案馆",
		//				"condition_detail": {
		//					"Q_LIKE_HOUSE_HOLDER": "曹卫明",
		//					"Q_LIKE_HOME_ADDRESS": "向化公社齐北大队6生产队",
