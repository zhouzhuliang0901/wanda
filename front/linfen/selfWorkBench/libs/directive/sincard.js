...
//						},2000)
			...
			$scope.getImgbaseStr = function(idCardNo, name, imgUrl) {
				$.ajax({
					type: "post",
					url: "http://10.81.16.56:8080/ac-product/aci/autoterminal/archives/getLicenseStuffList.do",
					data: {
						stIdNo: idCardNo,
						type: 0,
			...
			$scope.uploadIdCardImg = function(idCardNo, name, imgUrl) {
				...
				$.device.httpUpload(
					"http://10.81.16.56:8080/ac-product/aci/autoterminal/archives/saveLicenseStuff.do",
					"FileData",
					imgUrl,
