...
if($.getConfigMsg.isCommunity == 'Y' || $.getConfigMsg.isCommunity == null || $.getConfigMsg.isCommunity ==  undefined) {
	...
	perjsonStr = [{
		...
		"stuffName": "婚姻登记预约",
		"type": "../MZ_marriageAppointment/index.html",
		"ywlx": "",
		"img": "../libs/common/images/newIcon/JG.png",
	}, {
		"stuffName": "社区事务受理地址查询",
		"type": "../MZ_communityServiceCentreEnquiries/index.html",
		"ywlx": "",
		"img": "../libs/common/images/newIcon/JG.png",
	}];
}
