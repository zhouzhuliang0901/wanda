...
let jlzlType = [{
	"id": "1",
	"name": "是否曾被判处管制、拘役、有期徒刑、无期徒刑、死刑、罚金、剥夺政治权利、没收财产以及已构成犯罪，被人民法院判处免予刑事处罚的犯罪信息，包括缓刑、假释、暂予监外执行等执行方式；"
}, {
	"id": "2",
	"name": "是否曾被处以收容教育、劳动教养、强制隔离戒毒（强制戒毒）、责令社区戒毒（限期戒毒）的违法信息，包括不执行、暂缓执行、所外执行等执行方式；"
}, {
	"id": "3",
	"name": "是否曾被处以行政拘留、暂扣或吊销许可证的违法信息；"
}, {
	"id": "4",
	"name": "是否曾被处以警告、罚款、没收的违法信息，不包括交通类违法信息。"
}]
let expressMode = [{
	"id": "1",
	"name": "网上下载"
