app.controller("infoEducatedYouthToMountainAndCountryside", function($scope, $state, appData, appFactory, $http, $timeout, $rootScope) {
...
//			return ''
		...
		appData.submitInfo = {
			...
			stMCdate: $scope.stMCdate,
			stMCaddress: $scope.stMCaddress,
			stStartAddress: $scope.stStartAddress,
		...
		$scope.param = {
			...
			"query": {
				...
				"condition_detail": { //查询条件
					"Q_EQ_NAME": appData.submitInfo.stName,
					"Q_LIKE_COUNTRYSIDE_ADDRESS": appData.submitInfo.stMCaddress,
					"Q_LIKE_WAYGOING_TIME": appData.submitInfo.stMCdate,
					"Q_LIKE_STARTING_POINT": appData.submitInfo.stStartAddress,
		...
		//				"condition_detail": {
		//					"Q_LIKE_NAME": "朱显清",
		//					"Q_LIKE_COUNTRYSIDE_ADDRESS": "新疆军区生产建设兵团",
		//					//					"Q_LIKE_WAYGOING_TIME": "",
		//					//					"Q_LIKE_STARTING_POINT": "",
