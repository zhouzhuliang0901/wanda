...
app.controller('guideline', function($state, $scope, appData) {
	...
	appData.funName = $scope.funName = "崇明区居住绿地树种推荐";
	$.getConfigMsg.preUrlSelf = "http://10.5.20.217:8050/ac-product";
	appData.itemCode = "3120Q5001000";
...
app.controller('info', function($state, $scope, appData, appFactory, $http) {
	...
	$scope.nextStep = function() {
		...
		var fConfig = {
			...
			'applyNo': '',
			'itemCode': '11310230MB2F31269133120Q500100002', // data.itemTenNo	'0101220000-00-00-2'
			'itemName': '崇明区居住绿地树种推荐',
			'userId': '',
			'source': '网上申请',
			'departCode':'SH00CM',
