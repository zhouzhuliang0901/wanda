app.controller("infoReproductionOfChildren", function($scope, $state, appData, appFactory, $http, $timeout, $rootScope) {
	...
	$scope.nextStep = function() {
		...
		appData.submitInfo = {
			...
			stChildBirth: $scope.stChildBirth,
		...
		$scope.param = {
			...
			"query": {
				...
				"condition_detail": { //查询条件
					"Q_LIKE_MAN": (appData.submitInfo.stSex == "男") ? appData.submitInfo.stName : appData.submitInfo.stMateName,
					"Q_LIKE_WOMAN": (appData.submitInfo.stSex == "女") ? appData.submitInfo.stName : appData.submitInfo.stMateName,
					"Q_LIKE_MAN_BORNDATE": (appData.submitInfo.stSex == "男") ? appData.submitInfo.stBirth : appData.submitInfo.stMateBirth,
					"Q_LIKE_WOMAN_BORNDATE": (appData.submitInfo.stSex == "女") ? appData.submitInfo.stBirth : appData.submitInfo.stMateBirth,
					"Q_LIKE_MAN_IDENTIFICATION": (appData.submitInfo.stSex == "男") ? appData.submitInfo.stIdCard : appData.submitInfo.stMateIdCard,
					"Q_LIKE_WOMAN_IDENTIFICATION": (appData.submitInfo.stSex == "女") ? appData.submitInfo.stIdCard : appData.submitInfo.stMateIdCard,
					"Q_LIKE_BZHZXM": appData.submitInfo.stChildName,
					"Q_LIKE_BZHZCSRQ": appData.submitInfo.stChildBirth,
		...
		//					"Q_LIKE_MAN": "陈伟新",
		//					"Q_LIKE_WOMAN": "汪桂香",
		//					//					"Q_LIKE_MAN_BORNDATE": "xxxx",
		//					//					"Q_LIKE_WOMAN_BORNDATE": "xxxx",
		//					"Q_LIKE_MAN_IDENTIFICATION": "310222197201102817",
		//					"Q_LIKE_WOMAN_IDENTIFICATION": "342623198506088345",
		//					"Q_LIKE_BZHZXM": "丁陆怡",
		//					//					"Q_LIKE_BZHZCSRQ": "XXXX",
		//					"Q_EQ_DISTRICT": "jiading"
		//				}
		//			}
		//		}
