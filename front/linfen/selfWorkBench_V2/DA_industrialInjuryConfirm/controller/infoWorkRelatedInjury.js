app.controller("infoWorkRelatedInjury", function($scope, $state, appData, appFactory, $http, $timeout, $rootScope) {
...
//			return ''
		...
		appData.submitInfo = {
			...
			stCasualtyName: $scope.stCasualtyName,
			stEmployer: $scope.stEmployer,
			stCasualtyIdCard: $scope.stCasualtyIdCard,
			stCasualtyDate: $scope.stCasualtyDate,
		...
		$scope.param = {
			...
			"query": {
				...
				"condition_detail": { //查询条件
					"Q_EQ_SWRXM": appData.submitInfo.stCasualtyName,
					"Q_LIKE_YRDWMC": appData.submitInfo.stEmployer,
					"Q_LIKE_GSRDRQ": appData.submitInfo.stCasualtyDate,
					"Q_LIKE_SFZHM": appData.submitInfo.stCasualtyIdCard,
