//知青子女入户档案查询
app.controller("infoChildrenOfEducatedYouthToHousehold", function($scope, $state, appData, appFactory, $http, $timeout, $rootScope) {
...
//			return ''
		...
		appData.submitInfo = {
			...
			stMather: $scope.stMather,
			stFather: $scope.stFather,
			stChildName:$scope.stChildName,
			stHouseholdDate: $scope.householdDate,
			sthouseholdAddress: $scope.householdAddress,
		...
		$scope.param = {
			...
			"query": {
				...
				"condition_detail": { //查询条件
					"Q_EQ_CHILD_NAME": appData.submitInfo.stChildName,
					"Q_EQ_FATHER_NAME": appData.submitInfo.stFather,
					"Q_EQ_MOTHER_NAME": appData.submitInfo.stMother,
					"Q_LIKE_ENTER_DATE": appData.submitInfo.stHouseholdDate,
					"Q_LIKE_DATE_OF_BIRTH": appData.submitInfo.stBirth,
					"Q_LIKE_DOMICILE_ADDRESS": appData.submitInfo.sthouseholdAddress,
		...
		//				"ssdagmc": "崇明区档案馆",
		//				"condition_detail": {
		//					"Q_LIKE_CHILD_NAME": "张巍巍",
		//					"Q_LIKE_FATHER_NAME": "张永和",
		//					"Q_LIKE_MOTHER_NAME": "鲍文英",
		//					//					"Q_LIKE_ENTER_DATE": "",
		//					//					"Q_LIKE_DATE_OF_BIRTH": "",
		//					//					"Q_LIKE_DOMICILE_ADDRESS": "",
		//					"Q_EQ_DISTRICT": "minhang"
		//				}
		//			}
		//		}
