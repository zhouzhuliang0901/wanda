...
app.controller('houseLIist', function($state, $scope, appData, $rootScope, $timeout) {
...
app.controller('info', function($state, $scope, appData, $rootScope) {
	...
	$scope.queryInfo = function() {
		$scope.isLoading = true;
		$.customAjax.post($.getConfigMsg.preUrlSelf + '/selfapi/housingManagement/publicBenefits.do', {
			tokenSNO: $rootScope.tokenSNO,
