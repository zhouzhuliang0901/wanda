app.controller("infoEducatedYouthToCity", function($scope, $state, appData, appFactory, $http, $timeout, $rootScope) {
...
//			return ''
		...
		$scope.param = {
			...
			"query": {
				...
				"ssdagmc": (appData.submitInfo.stArchivesAddress == "不详") ? "" : appData.submitInfo.stArchivesAddress, //区县档案馆名称
				"condition_detail": { //查询条件
					...
					"Q_LIKE_ RETURN_TIME": appData.submitInfo.stCityDate,
		...
		//				"condition_detail": {
		//					"Q_LIKE_NAME": "徐锡琴",
		//					//					"Q_LIKE_COUNTRYSIDE_ADDRESS": "xxxx",
		//					//					"Q_LIKE_WAYGOING_TIME": "xxxx",
		//					//					"Q_LIKE_ RETURN_TIME": "xxxx",
