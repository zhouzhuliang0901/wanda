var perjsonStr = [{
	...
	"stuffName": "残疾评定预约日期查询、变更",
	"type": "CL_disabilityAssessmentAppointment",
	"ywlx": "00",
	"img": "../libs/common/images/newIcon/GA.png",
}];
console.log($.getConfigMsg.isCommunityNew);
if ($.getConfigMsg.isCommunityNew == 'Y' && jQuery.getConfigMsg.isCommunity !== "N") {
	perjsonStr = [{
		"stuffName": "听力、言语残疾人信息卡套餐服务申请",
		"type": "CL_informationCard",
		"ywlx": "00",
...
} else if ($.getConfigMsg.isCommunity != "N") {
	perjsonStr = [{
		"stuffName": "残疾人交通补贴申请",
		"type": "CL_travelAllowance",
		"ywlx": "00",
