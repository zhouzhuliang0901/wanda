		...
		$scope.param = {
			...
			"query": {
				...
				"condition_detail": { //查询条件
					"Q_EQ_FATHER_NAME": (appData.submitInfo.stSex == "男") ? appData.submitInfo.stName : appData.submitInfo.stWomen,
					"Q_EQ_MOTHER_NAME": (appData.submitInfo.stSex == "女") ? appData.submitInfo.stName : appData.submitInfo.stWomen,
					"Q_LIKE_DATE_OF_BIRTH": "",//infoOnlyChild
