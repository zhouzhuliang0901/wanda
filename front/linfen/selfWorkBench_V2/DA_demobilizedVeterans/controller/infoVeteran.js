app.controller("infoVeteran", function($scope, $state, appData, appFactory, $http, $timeout, $rootScope) {
...
//			return ''
		...
		appData.submitInfo = {
			...
			stEnlistedTroops: $scope.stEnlistedTroops,
			stEnlistedDate: $scope.stEnlistedDate,
			stEnlistedWork: $scope.stEnlistedWork,
		...
		$scope.param = {
			...
			"query": {
				...
				"condition_detail": { //查询条件
					...
					"Q_LIKE_RWBD": appData.submitInfo.stEnlistedTroops,
					"Q_LIKE_RWSJ": appData.submitInfo.stEnlistedDate,
					"Q_LIKE_RWQGZDW": appData.submitInfo.stEnlistedWork,
		...
		//				"condition_detail": {
		//					"Q_LIKE_NAME": "沈文燕",
		//					"Q_LIKE_RWBD": "河南省洛阳市80304部队",
		//					//					"Q_LIKE_RWSJ": "xxxxx",
		//					//					"Q_LIKE_RWQGZDW": "xxxxx",
		//					//					"Q_LIKE_SFZH": "xxxxx",
		//					"Q_EQ_DISTRICT": "qingpu"
		//				}
		//			}
		//		}
