...
//	$scope.getMatterCon(0,"总累计");
	...
	recordUsingHistory('医保服务', '查询', '年度累计医疗费用信息查询', appData.licenseName, appData.licenseNumber, '', '', JSON.stringify($scope.jsonStr));
	trackEventForQuery('年度累计医疗费用信息查询','','查询','上海市医疗保障局',appData.licenseName,appData.licenseNumber,'');
