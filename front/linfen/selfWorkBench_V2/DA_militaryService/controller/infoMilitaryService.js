app.controller("infoMilitaryService", function($scope, $state, appData, appFactory, $http, $timeout, $rootScope) {
		...
		$scope.param = {
			...
			"query": {
				...
				"condition_detail": { //查询条件
					...
					"Q_LIKE_JSDB": appData.submitInfo.stEnlistedTroops,
					"Q_LIKE_JTDZ": appData.submitInfo.stAddress,
					"Q_LIKE_CSRQ": appData.submitInfo.stBirth,
