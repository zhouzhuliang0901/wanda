//市级人才引进审批档案查询
app.controller("infoTalentIntroductionToCity", function($scope, $state, appData, appFactory, $http, $timeout, $rootScope) {
...
//			return ''
		...
		appData.submitInfo = {
			...
			stFollowPersonnel: $scope.stFollowPersonnel,
			stDLZH: $scope.stDLZH,
			stUnitAddress: $scope.stUnitAddress,
			stArchivesAddress: "上海市",
			stArchivesAddressCode: "shdaj",
		...
		$scope.param = {
			...
			"query": {
				...
				"condition_detail": { //查询条件
					"Q_EQ_NAME": (appData.submitInfo.stSex == "男") ? appData.submitInfo.stName : appData.submitInfo.stMateName,
					"Q_EQ_POXM": (appData.submitInfo.stSex == "女") ? appData.submitInfo.stName : appData.submitInfo.stMateName,
					"Q_LIKE_SQRY": appData.submitInfo.stFollowPersonnel,
					"Q_LIKE_SFZH": appData.submitInfo.stIdCard,
					"Q_LIKE_DLZH": appData.submitInfo.stDLZH,
					"Q_LIKE_DWDZ": appData.submitInfo.stUnitAddress,
		...
		//					"Q_LIKE_POXM": "鲍道良",
		//					//					"Q_LIKE_SQRY": "白少英、白翔",
		//					"Q_LIKE_SFZH": "340104470202152",
		//					"Q_LIKE_DLZH": "沪人（1996）调字第4-356号",
		//					//					"Q_LIKE_DWDZ": "XXXX",
		//					"Q_EQ_DISTRICT": "shdaj"
		//				}
		//			}
