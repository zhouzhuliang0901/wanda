app.controller("infoStudentStatus", function($scope, $state, appData, appFactory, $http, $timeout, $rootScope) {
	...
	$scope.nextStep = function() {
		...
		appData.submitInfo = {
			...
			stStudentName: $scope.stStudentName,
			stSchool: $scope.stSchool,
			stStudentBitrh: $scope.stStudentBitrh,
			stEducation: $scope.stEducation,
			stJb: $scope.stJb,
			stStudyStart: $scope.stStudyStart,
			stStudyEnd: $scope.stStudyEnd,
		...
		$scope.param = {
			...
			"query": {
				...
				"condition_detail": { //查询条件
					"Q_LIKE_XSXM": appData.submitInfo.stStudentName,
					"Q_LIKE_XXMC": appData.submitInfo.stSchool,
					"Q_LIKE_CSRQ": appData.submitInfo.stStudentBitrh,
					"Q_LIKE_XL": appData.submitInfo.stEducation,
					"Q_LIKE_JB": appData.submitInfo.stJb,
					"Q_LIKE_JDQSNF": appData.submitInfo.stStudyStart,
					"Q_LIKE_JDZZNF": appData.submitInfo.stStudyEnd,
