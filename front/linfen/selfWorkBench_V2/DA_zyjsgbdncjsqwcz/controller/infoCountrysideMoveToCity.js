//专业技术干部的农村家属迁往城镇审批档案
app.controller("infoCountrysideMoveToCity", function($scope, $state, appData, appFactory, $http, $timeout, $rootScope) {
...
//			return ''
		...
		appData.submitInfo = {
			...
			stFamilyName: $scope.stFamilyName,
			stDLZH: $scope.stDLZH,
		...
		$scope.param = {
			...
			"query": {
				...
				"condition_detail": { //查询条件
					...
					"Q_LIKE_NCJSXM": appData.submitInfo.stFamilyName,
