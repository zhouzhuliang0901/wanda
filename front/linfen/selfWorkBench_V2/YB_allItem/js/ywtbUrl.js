var perjsonStr = [{
	...
	},
	{
		...
		"stuffName": "医保定点药店查询",
		"url": "../YB_queryDrugstoreInfo/index.html",
		"ywlx": "",
		"img": "../libs/common/images/newIcon/YB.png",
	}
	//	, {
...
}else if(jQuery.getConfigMsg.isCommunityNew == "Y"  && jQuery.getConfigMsg.isCommunity !== "N") {
	perjsonStr = [{
