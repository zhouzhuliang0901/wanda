app.config(['$routeProvider',function($routeProvider){
    $routeProvider
    	...
    	.when('/onlineHandle',{templateUrl:'views/onlineHandle.html', controller:'onlineHandleController'})
		.when('/oneThingOneTime',{templateUrl:'views/oneThingOneTime.html', controller:'oneThingOneTimeController'})
