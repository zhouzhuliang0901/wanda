...
//var urlHost = 'http://10.81.16.56:8080/ac-product';	// 外网地址
var urlHost = 'http://zwdt.huangpuqu.sh.cn:8080/ac';	// 外网地址
//var urlHost1 = 'http://10.81.16.56:8080/ac-product';
//var urlHost1 = 'http://zwdt.huangpuqu.sh.cn:8080/ac';
var urlHost1 = 'http://xzfwzx.jingan.gov.cn:8080/ac';   // 静安外网地址
var JA_Extranet_urlHost = 'http://xzfwzx.jingan.gov.cn:8080/ac';   // 静安外网地址
//var urlHost = ''; // 数据最新的地址
//function qumethod(name){
//	switch(name){
//		case "黄浦区":
