(function (w) {
	...
	w.LODOP_PRINT.idcardPrint = function (frontImg,backImg) {
		...
		if($.getConfigMsg.isAnfeng =='Y') {
			lodop.ADD_PRINT_IMAGE(140, 220, 880, 1000, "<img border='0' style='width:200px;height:320px;' src='"+frontImg+"'>");
			lodop.ADD_PRINT_IMAGE(460, 220, 380, 1000, "<img border='0' style='width:200px;height:320px;' src='"+backImg+"'>");
			lodop.SET_PRINT_STYLEA(0, "Stretch", 2); //按原图比例(不变形)缩放模式
//			lodop.ADD_PRINT_IMAGE(240, 120, 880, 1000, "<img border='0' style='width:200px;height:320px;' src='"+frontImg+"'>");
//			lodop.SET_PRINT_STYLEA(0, "Stretch", 2); //按原图比例(不变形)缩放模式
//			lodop.SET_PRINT_STYLEA(0,"AngleOfPageInside",-90);
//			lodop.ADD_PRINT_IMAGE(240, 420, 380, 1000, "<img border='0' style='width:200px;height:320px;' src='"+backImg+"'>");
...
//			lodop.SET_PRINT_STYLEA(0,"AngleOfPageInside",-90);
	...
	w.LODOP_PRINT.materialPrint = function (img) {
		lodop.ADD_PRINT_IMAGE(0, 0, 880, 1000, "<img border='0'  src='"+img+"'>");
		lodop.SET_PRINT_STYLEA(0, "Stretch", 2); //按原图比例(不变形)缩放模式
		lodop.PRINT();
	};
