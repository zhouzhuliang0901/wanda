...
public class InfopubDeviceInfo implements Serializable {
     ...
     * 更新时间
     */
    public static final String ST_UPDATE = "ST_UPDATE";
     ...
     */
    @Excel(name="更新时间")
    @Column(name = "ST_UPDATE")
    private Timestamp stUpdate;
     ...
     * 更新时间
     */
    public String stUpdate2Html(String pattern) {
        if (this.stUpdate == null) {
            ...
            return new SimpleDateFormat(pattern).format(this.stUpdate);
        }
    }
     ...
     * 更新时间
     */
    public void setStUpdate(Timestamp stUpdate) {
