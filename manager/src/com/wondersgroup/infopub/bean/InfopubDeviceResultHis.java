...
@Entity
@Table(name = "INFOPUB_DEVICE_RESULT_HIS")
public class InfopubDeviceResultHis implements Serializable {
    
    /**
     * 设备状态结果历史
     */
    public static final String INFOPUB_DEVICE_RESULT_HIS = "INFOPUB_DEVICE_RESULT_HIS";
