...
@Entity
@Table(name = "INFOPUB_WORKSPACE_USER")
public class InfopubWorkspaceUser implements Serializable {
    
    /**
     * 信息发布用户关联空间
     */
    public static final String INFOPUB_WORKSPACE_USER = "INFOPUB_WORKSPACE_USER";
