...
public class InfopubDeviceType implements Serializable {
     ...
     * 设备类型
     */
    public static final String NM_DTYPE = "NM_DTYPE";
     ...
     * 设备类型
     */
    @Column(name = "NM_DTYPE")
    private BigDecimal nmDtype;
    ...
    public void setStIcon(String stIcon) {
       // stIcon = StringUtil.substringBySize(stIcon, 5000, "GB18030");
        this.stIcon = stIcon;
    }
     ...
     * 设备类型
     */
    public String nmDtype2Html(int precision) {
        if (this.nmDtype == null) {
            return "";
        } else {
            String pattern = "0";
            if (precision > 0) {
            ...
            return new DecimalFormat(pattern).format(this.nmDtype);
        }
    }
     ...
     * 设备类型
     */
    public void setNmDtype(BigDecimal nmDtype) {
        this.nmDtype = nmDtype;
    }
