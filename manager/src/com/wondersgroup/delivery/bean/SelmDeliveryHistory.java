...
@Entity
@Table(name = "SELM_DELIVERY_HISTORY")
public class SelmDeliveryHistory implements Serializable {
    
    /**
     * 快递柜历史
     */
    public static final String SELM_DELIVERY_HISTORY = "SELM_DELIVERY_HISTORY";
