...
@Entity
@Table(name = "SELM_CLIENT_STAT_DAY")
public class SelmClientStatDay implements Serializable {
    
    /**
     * 终端业务统计（按天）
     */
    public static final String SELM_CLIENT_STAT_DAY = "SELM_CLIENT_STAT_DAY";
    ...
    public void setStDate(String stDate) {
        stDate = StringUtil.substringBySize(stDate, 500, "GB18030");
        this.stDate = stDate;
    }
