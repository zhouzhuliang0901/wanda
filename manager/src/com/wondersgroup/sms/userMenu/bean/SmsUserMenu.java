package com.wondersgroup.sms.userMenu.bean;
...
@Entity
@Table(name = "SMS_USER_MENU")
public class SmsUserMenu implements Serializable {
    
    /**
     * 用户菜单
     */
    public static final String SMS_USER_MENU = "SMS_USER_MENU";
