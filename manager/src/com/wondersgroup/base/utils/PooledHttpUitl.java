...
public class PooledHttpUitl {
	...
	public static CloseableHttpClient getCloseableHttp(int maxTotal, 
        ...
        try {
	        ...
	        poolConnManager.setDefaultMaxPerRoute(defaultMaxPerRoute);// 设置最大路由
	        //  初始化httpClient
	        CloseableHttpClient httpClient = getConnection(poolConnManager);
	        return httpClient;
