...
<body>
	<div class="page-container">
		<form class="form form-horizontal" id="form-device-add">
		  <input type="hidden" name="<%=InfopubDeviceType.ST_TYPE_ID%>" id="stSampleId" value="" />          
          <input type="hidden" name="<%=InfopubDeviceType.ST_PARENT_TYPE_ID%>" id="stParentTypeId" value="<%=infopubDeviceType.stTypeId2Html()%>" />
          <div class="row cl">
           ...
           <%-- <div class="row cl">
                ...
                <div class="formControls col-xs-4 col-sm-4">
                    <input type="text" class="input-text"
                        value="<%=infopubDeviceType.stTypeId2Html()%>"
                        name="<%=InfopubDeviceType.ST_PARENT_TYPE_ID %>" required>
                </div>
           </div> --%>
            ...
            <%-- <div class="row cl">
	            <shiro:hasRole name="admin">
		                <div class="row cl">
		                     <label class="form-label col-xs-4 col-sm-2">父ID：</label>
		                     <div class="formControls col-xs-4 col-sm-4">
		                         <span class="select-box"> 
		                            <select name="<%=InfopubDeviceType.ST_PARENT_TYPE_ID %>" class="select" id="workSpaceSelect">
	                                    <script id="workspaceList" type="text/html">
                                        {{each data}}
                                            <option value="{{$value.stTypeId}}" {{if workspace == $value.stTypeId}} selected='selected' {{/if}}>
                                                    {{$value.stTypeId}}</option>
                                        {{/each}} 
                                    </script>  
		                            </select> 
		                         </span>
