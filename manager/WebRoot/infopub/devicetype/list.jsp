...
<body>
	<nav class="breadcrumb">
		...
		设备管理 <span class="c-gray en">&gt;</span>设备分类 <a
	...
	<div class="page-container">
		...
		<div class="text-c">
		    ...
		    <input type="text" name="" id="searchName" placeholder="类型名称" style="width:250px"
				class="input-text">
...
var table = $('#typeList').dataTable({
    ...
    "aoColumns": [
                ...
                }},
                {
                 "data": "stTypeId",
                 "render": function (data, type, full, meta) {
                        	var returnInfo = "<a style=\"text-decoration:none\" class=\"ml-5\" onClick=\"device_info('"+full.stTypeName+"->查看','/infopub/deviceinfotype/info.do','"+data+"')\" href=\"javascript:;\" title=\"查看\"><i class=\"icon iconfont icon-chakan\"></i></a>";
                            returnInfo += "<a style=\"text-decoration:none\" class=\"ml-5\" onClick=\"device_edit('"+full.stTypeName+"->编辑','/infopub/deviceinfotype/edit.do','"+data+"')\" href=\"javascript:;\" title=\"编辑\"><i class=\"icon iconfont icon-edit\"></i></a>";
      ...
      "bLengthChange": true ,//改变每页显示数据数量
       "ajax": {
		    url:webRoot+'/infopub/deviceinfotype/list.do',
		    type:"POST",
		    data: function(d){
...
function setImageData(data){
    if(data == ''){
        return '<span class=\"label label-danger radius\">无图片</span>';
    } else {
        return '<img src=data:image/png;base64,'+ data + ' style=\"width: 100px;height: 80px\">'
    }
}
