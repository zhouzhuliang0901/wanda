...
<body>
	<nav class="breadcrumb">
		...
		设备运维 <span class="c-gray en">&gt;</span>设备运维 <a
...
<%-- var stRoleName = '<%= (Object)request.getSession().getAttribute("stRoleName")%>'; --%>
                ...
                }, */
                {
                 ...
                 "render": function (data, type, full, meta) {
                          var   returnInfo = "<a style=\"text-decoration:none\" class=\"ml-5\" onClick=\"device_opt('"+data+"','snapshots','截屏')\" href=\"javascript:;\" title=\"截屏\"><i class=\"icon iconfont icon-jieping\"></i></a>";
                               ...
                               //returnInfo += "<a style=\"text-decoration:none\" class=\"ml-5\" onClick=\"device_opt('"+data+"','rundebug','运行DEBUG')\" href=\"javascript:;\" title=\"运行DEBUG\"><i class=\"iconfont icon-yunhangchengxu\"></i></a>";
                               //returnInfo += "<a style=\"text-decoration:none\" class=\"ml-5\" onClick=\"device_opt('"+data+"','redebug','重启DEBUG')\" href=\"javascript:;\" title=\"重启DEBUG\"><i class=\"iconfont icon-lvzhou_zhongqi\"></i></a>";
...
//                 }
       ...
       "createdRow": function( row, data, dataIndex ) {
                    ...
                    //$(row).children('td').eq(8).attr('style', 'right-padding: 0px;');
                    /* $(row).children('td').eq(7).attr('style', 'text-align: center;'); */
