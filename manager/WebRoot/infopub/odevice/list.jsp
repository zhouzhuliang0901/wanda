...
<body>
	<nav class="breadcrumb">
		...
		设备管理 <span class="c-gray en">&gt;</span>外设管理 <a
...
var table = $('#typeList').dataTable({
    ...
    "aoColumns": [
                ...
                }},
                {
                 "data": "stTypeId",
                 "render": function (data, type, full, meta) {
                        	var returnInfo = "<a style=\"text-decoration:none\" class=\"ml-5\" onClick=\"device_info('"+full.stTypeName+"->查看','/infopub/odeviceInfo/info.do','"+data+"')\" href=\"javascript:;\" title=\"查看\"><i class=\"icon iconfont icon-chakan\"></i></a>";
                            returnInfo += "<a style=\"text-decoration:none\" class=\"ml-5\" onClick=\"device_edit('"+full.stTypeName+"->编辑','/infopub/odeviceInfo/edit.do','"+data+"')\" href=\"javascript:;\" title=\"编辑\"><i class=\"icon iconfont icon-edit\"></i></a>";
      ...
      "bLengthChange": true ,//改变每页显示数据数量
       "ajax": {
		    url:webRoot+'/infopub/odeviceInfo/list.do',
		    type:"POST",
		    data: function(d){
		      var odeviceName = $("#searchName").val();
		      d.odeviceName = odeviceName;
...
function device_del(obj,id){
    layer.confirm('确认要删除吗？',function(index){
         $.ajax({
            type : 'POST',
            url : webRoot+'/infopub/odeviceInfo/remove.do',
            dataType:'json',
            data:{'stTypeId':id},
