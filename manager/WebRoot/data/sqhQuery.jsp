...
function init(){
	$.ajax({
			...
			success:function(data){
				...
				$("#statisticsDayList").append('<tr id="bo"><th id="yl"  width="100">'+yl+'</th>'+
							'<th id="gs" width="100">'+gs+'</th>'+
							'<th id="sl" width="100">'+sl+'</th>'+
							'<th id="bl" width="100">'+bl+'</th></tr>');
			},
			error:function(){
			}
		});
