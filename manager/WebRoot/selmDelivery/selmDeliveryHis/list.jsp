...
var table = $('#typeList').dataTable({
    ...
    "aoColumns": [
                ...
                }},
                {
                 "data": "stDeliveryId",
                 "render": function (data, type, full, meta) {
                        var returnInfo = "<a style=\"text-decoration:none\" class=\"ml-5\" onClick=\"selmDelivery_info('"+full.stCabinetNo+"->查看','/delivery/selmDeliveryHistory/info.do','"+data+"')\" href=\"javascript:;\" title=\"查看\"><i class=\"icon iconfont icon-chakan\"></i></a>";
      ...
      "bLengthChange": true ,//改变每页显示数据数量
       "ajax": {
		    url:webRoot+'/delivery/selmDeliveryHistory/list.do',
		    type:"POST",
		    data: function(d){
		      var stMachineId = '<%=selmDeliveryHistory.getStMachineId()%>';
...
console.log(id)
    layer.confirm('确认要删除吗？',function(index){
         $.ajax({
            type : 'POST',
            url : webRoot+'/delivery/selmDeliveryHistory/remove.do',
            dataType:'json',
