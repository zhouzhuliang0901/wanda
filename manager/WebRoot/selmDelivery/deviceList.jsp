...
<%--    <link rel="stylesheet" type="text/css"--%>
<%--    href="https://at.alicdn.com/t/font_1743964_ctyk9tqenvp.css" />--%>
<%--<link rel="stylesheet" type="text/css"--%>
<%--    href="https://at.alicdn.com/t/font_1743964_p6o579aebz.css" />--%>
<%--<link rel="stylesheet" type="text/css"--%>
<%--    href="https:////at.alicdn.com/t/font_1743964_54s08lbcxv.css" />--%>
...
<body>
	<nav class="breadcrumb">
		...
		证照管理 <span class="c-gray en">&gt;</span>包裹入柜 <a
...
var table = $('#deviceList').dataTable({
    ...
    "aoColumns": [
                 ...
                 },
                {
                 "data": "stDeviceMac",
                 "render": function (data, type, full, meta) {
                        var returnInfo = "<a style=\"text-decoration:none\" class=\"ml-5\" onClick=\"device_info('"+full.stDeviceName+"->查看','/delivery/selmDelivery/deliveryDevice.do','"+data+"')\" href=\"javascript:;\" title=\"查看快递柜\"><i class=\"icon iconfont icon-chakan\"></i></a>";
                        	returnInfo += "<a style=\"text-decoration:none\" class=\"ml-5\" onClick=\"device_info('"+full.stDeviceName+"->查看','/delivery/selmDeliveryHistory/deliveryHistoryDevice.do','"+data+"')\" href=\"javascript:;\" title=\"查看快递柜历史\"><i class=\"icon iconfont icon-chakanlishi\"></i></a>";
                        return returnInfo;
                    },
                  "bSortable": false
                },
                {
                 "data": "stDeviceId",
                 "render": function (data, type, full, meta) {
                          var   returnInfo = "<a style=\"text-decoration:none\" class=\"ml-5\" onClick=\"device_opt('"+data+"','snapshots','截屏')\" href=\"javascript:;\" title=\"截屏\"><i class=\"icon iconfont icon-jieping\"></i></a>";
