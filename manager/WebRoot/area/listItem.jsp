...
<body>
	<nav class="breadcrumb">
		...
		区域管理 <span class="c-gray en">&gt;</span>区域信息 <a
	...
	<div class="page-container">
		...
		<div class="text-c">
		    ...
		    <input type="text" name="" id="searchName" placeholder="区域名称" style="width:250px"
				class="input-text">
...
var table = $('#typeList').dataTable({
    ...
    "aoColumns": [
                ...
                }},
                {
                 "data": "stAreaId",
                 "render": function (data, type, full, meta) {
                       // var returnInfo = "<a style=\"text-decoration:none\" class=\"ml-5\" onClick=\"device_info('"+full.stTypeName+"->外设','/infopub/deviceinfotype/info.do','"+data+"')\" href=\"javascript:;\" title=\"查看\"><i class=\"icon iconfont icon-chakan\"></i></a>";
                           var returnInfo = "<a style=\"text-decoration:none\" class=\"ml-5\" onClick=\"device_edit('"+full.stAreaName+"->编辑','/infopub/area/edit.do','"+data+"')\" href=\"javascript:;\" title=\"编辑\"><i class=\"icon iconfont icon-edit\"></i></a>";
...
function device_info(title,url,id){
    var index = layer.open({
        type: 2,
        title: title,
        content: webRoot+url+'?ST_AREA_ID='+id
    });
    layer.full(index);
}
// 编辑
