...
<body>
	<nav class="breadcrumb">
		...
		系统管理<span class="c-gray en">&gt;</span>用户组设置<a
	...
	<div class="page-container">
		<div class="text-c">
		    ...
		    <input type="text" name="" id="searchCode" placeholder="用户组名称" style="width:250px"
				class="input-text">
			...
			<table width="100%"
				...
				<thead>
					<tr class="text-c">
						...
						<th width="80">用户组编码</th>
						<th width="220">用户组名称</th>
						<th width="50">排序字段</th>
						<th width="80">创建时间</th>
						<th width="80">操作</th>
					</tr>
...
var table = $('#groupList').dataTable({
    ...
    "aoColumns": [
                  ...
                  },},
                {
                 "data": "stGroupId",
                 "render": function (data, type, full, meta) {
                  return "<a style=\"text-decoration:none\" class=\"ml-5\" onClick=\"role_info('角色查看','/sms/group/info.do','"+data+"')\" href=\"javascript:;\" title=\"查看\"><i class=\"Hui-iconfont\">&#xe725;</i></a>"+
                     "<a style=\"text-decoration:none\" class=\"ml-5\" onClick=\"role_edit('角色编辑','/sms/group/edit.do','"+data+"')\" href=\"javascript:;\" title=\"编辑\"><i class=\"Hui-iconfont\">&#xe647;</i></a>"+ 
      ...
      "bLengthChange": true ,//改变每页显示数据数量
       "ajax": {
		    url:webRoot+'/sms/group/list.do',
		    type:"POST",
		    data: function(d){
		      // 样表名称
		      var stGroupName = $("#searchCode").val();
		      d.stGroupName = stGroupName;
		      // 开始时间
...
function role_del(obj,id){
    layer.confirm('确认要删除吗？',function(index){
         $.ajax({
            type : "POST",
            url : webRoot+'/sms/group/remove.do',
            dataType:"json",
            data:{"groupId":id},
