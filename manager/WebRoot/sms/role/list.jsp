...
<body>
	<nav class="breadcrumb">
		...
		系统管理<span class="c-gray en">&gt;</span>角色设置<a
	...
	<div class="page-container">
		<div class="text-c">
		    ...
		    <input type="text" name="" id="searchCode" placeholder="角色代码" style="width:250px"
				class="input-text">
		...
		<div class="cl pd-5 bg-1 bk-gray mt-20">
			<span class="l"><a href="javascript:;" onclick="datadel()"
				...
				onclick="role_add('添加 ','edit.jsp')" href="javascript:;"><i
					class="Hui-iconfont">&#xe600;</i> 添加</a> </span>
		</div>
		<div class="mt-20">
			<table width="100%"
				class="table table-border table-bordered table-bg table-hover table-sort" id="roleList">
				<thead>
					<tr class="text-c">
...
var table = $('#roleList').dataTable({
    ...
    "aoColumns": [
                  ...
                  },},
                {
                 "data": "stRoleId",
                 "render": function (data, type, full, meta) {
                  return "<a style=\"text-decoration:none\" class=\"ml-5\" onClick=\"role_info('角色查看','/sms/role/info.do','"+data+"')\" href=\"javascript:;\" title=\"查看\"><i class=\"Hui-iconfont\">&#xe725;</i></a>"+
                     "<a style=\"text-decoration:none\" class=\"ml-5\" onClick=\"role_edit('角色编辑','/sms/role/edit.do','"+data+"')\" href=\"javascript:;\" title=\"编辑\"><i class=\"Hui-iconfont\">&#xe647;</i></a>"+ 
                      "<a style=\"text-decoration:none\" class=\"ml-5\" onClick=\"role_del(this,'"+data+"')\" href=\"javascript:;\" title=\"删除\"><i class=\"Hui-iconfont\">&#xe6e2;</i></a>";
                    },
                  "bSortable": false
                }
            ],
      ...
      "bLengthChange": true ,//改变每页显示数据数量
       "ajax": {
		    url:webRoot+'/sms/role/list.do',
		    type:"POST",
		    data: function(d){
		      // 样表名称
		      var roleCode = $("#searchCode").val();
		      d.roleCode = roleCode;
		      // 开始时间
...
/*查看*/
function role_info(title,url,id){
    var index = layer.open({
        type: 2,
        title: title,
        content: webRoot+url+"?ST_ROLE_ID="+id
    });
    layer.full(index);
}
/*编辑*/
...
function role_del(obj,id){
    layer.confirm('确认要删除吗？',function(index){
         $.ajax({
            type : "POST",
            url : webRoot+'/sms/role/remove.do',
            dataType:"json",
            data:{"roleId":id},
