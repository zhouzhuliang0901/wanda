			...
			"aoColumns" : [
					...
					},
					{
						...
						"render" : function(data, type,
								...
								var returnInfo = "<a style=\"text-decoration:none\" class=\"ml-5\" onClick=\"item_add('"+full.stItemTypeName+"->授权','/app/selmDeviceitem/saveDeviceItemType.do','"+data+"')\" href=\"javascript:;\" title=\"添加事项\"><i class=\"Hui-iconfont\">&#xe600;</i></a>";
							return returnInfo;
						},
						"bSortable": false
