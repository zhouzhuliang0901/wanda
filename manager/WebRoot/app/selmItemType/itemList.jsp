...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;事项部门: <input type="text" name="" id="searchOrgan" placeholder=" 事项部门"
			...
			<div class="cl pd-5 bg-1 bk-gray mt-20">
				<span class="l"><a href="javascript:;" onclick="stItemLinkAdd()"
...
.dataTable(
		{
			...
			"ajax" : {
				url : webRoot + '/app/selmItemLink/itemNoLinkList.do',
				type : "POST",
				data : function(d) {
...
function stItemLinkAdd () {
 		...
 		for (var i = 0; i< selectList.length; i++){
			 ...
			 item_add('','/app/selmItemLink/save.do',idArray);
}
...
function item_add(title,url,id){
    $.ajax({
			...
			type : "POST",
			data : {
				stItemTypeId : '<%=selmItemType.getStItemTypeId()%>',
				//stItemTypeId :'1',
				stItemId : id
			},
