...
<body>
	<nav class="breadcrumb">
		...
		统计分析 <span class="c-gray en">&gt;</span>外设统计 <a
...
//                 }},
                ...
                }},
                {
                 "data": "stStatisticsId",
                 "render": function (data, type, full, meta) {
                        var returnInfo = "<a style=\"text-decoration:none\" class=\"ml-5\" onClick=\"statistics_info('"+full.stNetFlag+"->调用次数(按天)','/statistics/statistics/dayCountOdevice.do','"+data+"')\" href=\"javascript:;\" title=\"查看\">点击量(按天)</a>";
      ...
      "bLengthChange": true ,//改变每页显示数据数量
       "ajax": {
		    url:webRoot+'/statistics/selmStatistics/odevicelist.do',
		    type:"POST",
		    data: function(d){
