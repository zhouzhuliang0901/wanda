...
//                 }},
                ...
                }},
                {
                 "data": "stStatisticsId",
                 "render": function (data, type, full, meta) {
                        var returnInfo = "<a style=\"text-decoration:none\" class=\"ml-5\" onClick=\"statistics_info('"+full.stNetFlag+"->点击量(按天)','/statistics/statistics/dayCountInfo.do','"+data+"')\" href=\"javascript:;\" title=\"查看\">点击量(按天)</a>";
      ...
      "bLengthChange": true ,//改变每页显示数据数量
       "ajax": {
		    url:webRoot+'/statistics/selmStatistics/list.do',
		    type:"POST",
		    data: function(d){
