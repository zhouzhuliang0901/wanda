...
var table = $('#statisticsDayList').dataTable({
    ...
    "aoColumns": [
                ...
                }}, 
                {
                 "data": "stStatisticsId",
                 "render": function (data, type, full, meta) {
                        var returnInfo = "<a style=\"text-decoration:none\" class=\"ml-5\" onClick=\"statistics_client('"+full.stDate+"->设备外设调用量（按天）','/statistics/selmStatisticsDay/clientStstDayOdevice.do','"+data+"','"+full.stDate+"')\" href=\"javascript:;\" title=\"查看\">终端业务统计(按天)</a>";
                        return returnInfo;
                    },
                  "bSortable": false
                }
      ...
      "bLengthChange": true ,//改变每页显示数据数量
       "ajax": {
		    url:webRoot+'/statistics/selmStatisticsDay/odevicelist.do',
		    type:"POST",
		    data: function(d){
