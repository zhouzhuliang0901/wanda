...
<body>
	<nav class="breadcrumb">
		...
		统计分析 <span class="c-gray en">&gt;</span>类型统计 <a
	...
	<div class="page-container">
		...
		<div class="text-c" style="text-align: left;">
		    ...
		    <input type="text" name="设备类型" id="searchName" placeholder="设备类型" style="width:250px"
				class="input-text">
...
var table = $('#statisticsList').dataTable({
    ...
    "aoColumns": [
                ...
                }},
                {
                 "data": "stStatisticsId",
                 "render": function (data, type, full, meta) {
                        var returnInfo = "<a style=\"text-decoration:none\" class=\"ml-5\" onClick=\"statistics_day('"+full.stDate+"->业务统计（按天）','/statistics/statistics/suCountInfo.do','"+data+"','"+full.stDate+"')\" href=\"javascript:;\" title=\"查看\">业务统计(按天)</ a>";
                        return returnInfo;
                    },
                  "bSortable": false
                }
      ...
      "bLengthChange": true ,//改变每页显示数据数量
       "ajax": {
		    url:webRoot+'/statistics/statistics/suCount.do',
		    type:"POST",
		    data: function(d){
...
// 查看
function statistics_day(title,url,id,stDate){
