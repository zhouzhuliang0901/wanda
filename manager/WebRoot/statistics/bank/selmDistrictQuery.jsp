...
<%
    ...
    String city = selmStatistics.getStName();  
...
<body>
	<nav class="breadcrumb">
		...
		统计分析 <span class="c-gray en">&gt;</span>区域统计(银行) <a
	...
	<div class="page-container">
		...
		<div class="text-c" style="text-align: left;">
		   ...
		   <!--  <input type="text" name="" id="searchName" placeholder="所属区域" style="width:250px"
				class="input-text"> -->
			<span>&nbsp;&nbsp;&nbsp;</span>	
			设备分类：
    ...
    "aoColumns": [
                ...
                "render":function(data, type, full, meta){
                	...
                	if('总计'==data){
                	 	...
                	 	returnInfo= "<a style=\"text-decoration:none\" class=\"ml-5\" onClick=\"group_day('"+full.stAreaName+"->街道统计','/statistics/statistics/yhDistrictDeviceInfo.do','"+data+"')\" href=\"javascript:;\" title=\"查看\"><u>"+data+"</u></a>";
                	}
                     return returnInfo;
                  }},
                  { "data": "nmSocialNumber",
                  ...
                  { "data": "nmDay",
                	"render":function(data, type, full, meta){
                    var returnInfo = "<a style=\"text-decoration:none\" class=\"ml-5\" onClick=\"group_day('"+full.stAreaName+"->操作统计','/statistics/selmStatistics/bareaItemModule.do','"+full.stAreaName+"')\" href=\"javascript:;\" title=\"查看\"><u>"+data+"</u></a>";
                    return returnInfo;
                  },
                  "bSortable": false},
                   { "data": "stAreaName",
                	"render":function(data, type, full, meta){
                      var returnInfo =  "<a style=\"text-decoration:none\" class=\"ml-5\" onClick=\"item('"+full.stAreaName+"->事项办理量','/statistics/selmStatistics/bareaItemAmount.do','"+full.stAreaName+"')\" href=\"javascript:;\" title=\"查看\"><u>查看</u></a>";
	                  return returnInfo;
                  	},
                  	"bSortable": false},
      ...
      "bLengthChange": false ,//改变每页显示数据数量
       "ajax": {
		    url:webRoot+'/statistics/selmBDistrictQueryDay/list.do',
		    type:"POST",
		    data: function(d){
		    var stAreaId = areaId;
		      d.stAreaId = stAreaId; 
