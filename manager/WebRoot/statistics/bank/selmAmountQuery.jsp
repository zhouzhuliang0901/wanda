...
<body>
	...
	<div class="page-container">
		...
		&nbsp;&nbsp;&nbsp;&nbsp;事项名称: <input type="text" name="" id="searchItem" placeholder="事项名称: " style="width:250px"
				class="input-text">
...
var table = $('#statisticsDayList').dataTable({
    ...
    "aoColumns": [
      ...
      "bLengthChange": true,//改变每页显示数据数量
       "ajax": {
		    url:webRoot+'/statistics/selmStatistics/provinceItemAmountQuery.do',
		    type:"POST",
		    data: function(d){
		     var stProvinceName = '<%=selmStatistics.getStNetFlag()%>';
		      d.stProvinceName = stProvinceName;
		       var stCitytName = '<%=selmStatistics.getStName()%>';
		      d.stCitytName = stCitytName;
