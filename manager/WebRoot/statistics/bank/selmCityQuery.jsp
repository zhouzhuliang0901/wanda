...
<%
    ...
    String province = selmStatistics.getStName();  
...
<body>
	<nav class="breadcrumb">
		...
		统计分析 <span class="c-gray en">&gt;</span>城市统计(银行) <a
	...
	<div class="page-container">
		...
		<div class="text-c" style="text-align: left;">
		   ...
		   <!--  <input type="text" name="" id="searchName" placeholder="所属城市" style="width:250px"
				class="input-text"> -->
    ...
    "aoColumns": [
                ...
                "render":function(data, type, full, meta){
                	...
                	if('总计'==data){
                	 	...
                	 	returnInfo= "<a style=\"text-decoration:none\" class=\"ml-5\" onClick=\"group_day('"+full.stAreaName+"->区域统计','/statistics/statistics/toSelmDistrictQuery.do','"+data+"')\" href=\"javascript:;\" title=\"查看\"><u>"+data+"</u></a>";
                	}
                     return returnInfo;
                  }},
                  { "data": "nmSocialNumber",
                  ...
                  { "data": "nmDay",
                	...
                	if('总计' == full.stAreaName){
                    	...
                    	returnInfo = "<a style=\"text-decoration:none\" class=\"ml-5\" onClick=\"group_day('"+full.stAreaName+"->操作统计','/statistics/selmStatistics/bCityItemModule.do','"+full.stAreaName+"')\" href=\"javascript:;\" title=\"查看\"><u>"+data+"</u></a>";
                	}
                    return returnInfo;
                  },
                  "bSortable": false},
                   { "data": "stAreaName",
                	...
                	if('总计' == full.stAreaName){
                      ...
                      returnInfo =  "<a style=\"text-decoration:none\" class=\"ml-5\" onClick=\"item('"+full.stAreaName+"->事项办理量','/statistics/selmStatistics/bCityItemAmount.do','"+full.stAreaName+"')\" href=\"javascript:;\" title=\"查看\"><u>查看</u></a>";
                	}
	                  return returnInfo;
                  	},
                  	"bSortable": false},
      ...
      "bLengthChange": false ,//改变每页显示数据数量
       "ajax": {
		    url:webRoot+'/statistics/selmBCityQueryDay/list.do',
		    type:"POST",
		    data: function(d){
		    var stAreaId = areaId;
		      d.stAreaId = stAreaId; 
