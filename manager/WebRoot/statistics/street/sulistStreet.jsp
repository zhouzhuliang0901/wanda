...
<body>
	...
	<div class="page-container">
		...
		<div class="text-c" style="text-align: left;">
		   ...
		   所属区域: <input type="text" name="" id="searchName" placeholder="所属区域" style="width:250px"
				class="input-text">
...
var table = $('#statisticsDayList').dataTable({
    ...
    "aoColumns": [
                ...
                }},
                {
                 "data": "stName",
                 "render": function (data, type, full, meta) {
                       	var returnInfo = "<a style=\"text-decoration:none\" class=\"ml-5\" onClick=\"group_day('"+full.stName+"->点击量(按天)','/statistics/statistics/devicestreetDay.do','"+data+"')\" href=\"javascript:;\" title=\"查看\">终端业务统计(按天)</a>";
      ...
      "bLengthChange": false ,//改变每页显示数据数量
       "ajax": {
		    url:webRoot+'/statistics/selmStatistics/streetlist.do',
		    type:"POST",
		    data: function(d){
		     var stAreaId = areaId;
		      d.stAreaId = stAreaId; 
...
function group_day(title,url,id){
    var index = layer.open({
        type: 2,
        title: title,
        content: webRoot+url+'?ST_NAME='+id
    });
    layer.full(index);
} 
