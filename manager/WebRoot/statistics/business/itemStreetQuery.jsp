...
<%
    ...
    if (selmStatistics == null)
        ...
        String startDate = selmStatistics.getStNetFlag();  
...
<body>
	...
	<div class="page-container">
		...
		<!--    所在区: <input type="text" name="" id="searchName" placeholder="所属区域" style="width:250px"
				class="input-text"> -->
		&nbsp;&nbsp;&nbsp;&nbsp;所属街道: <input type="text" name="" id="searchName" placeholder="所属街道" style="width:250px"
				class="input-text">
       ...
       "ajax": {
		    ...
		    /* var stAreaId = areaId;
		      ...
		      d.stPermission = stPermission;  */
		       var stAddressName = '<%=selmStatistics.getStName()%>';
		      d.stAddressName = stAddressName;
		      var stItemName = '<%=selmStatistics.getStExt1()%>';
		      d.stItemName = stItemName;
              var stStreetsName = $("#searchName").val();
