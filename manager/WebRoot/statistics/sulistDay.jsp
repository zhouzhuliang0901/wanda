...
var table = $('#statisticsDayList').dataTable({
    ...
    "aoColumns": [
               ...
               /*  {
                 "data": "stStatisticsId",
                 "render": function (data, type, full, meta) {
                        var returnInfo = "<a style=\"text-decoration:none\" class=\"ml-5\" onClick=\"statistics_client('"+full.stDate+"->业务统计（按天）','/statistics/suCountInfo.do','"+data+"','"+full.stDate+"')\" href=\"javascript:;\" title=\"查看\">业务统计(按天)</a>";
                        return returnInfo;
                    },
                  "bSortable": false
                } */
      ...
      "bLengthChange": true ,//改变每页显示数据数量
       "ajax": {
		    url:webRoot+'/statistics/selmStatisticsDay/sulistDay.do',
		    type:"POST",
		    data: function(d){
