...
//                 }},
                ...
                }},
                {
                 "data": "stStatisticsId",
                 "render": function (data, type, full, meta) {
                        var returnInfo = "<a style=\"text-decoration:none\" class=\"ml-5\" onClick=\"statistics_info('"+full.stName+"->点击量(按天)','/statistics/statistics/devicetypeDay.do','"+data+"')\" href=\"javascript:;\" title=\"查看\">点击量(按天)</a>";
