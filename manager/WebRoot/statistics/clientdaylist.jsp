<%@page import="com.wondersgroup.statistics.bean.SelmStatisticsDay"%>
...
<%
	String webRoot = AppContext.webRootPath;
	 SelmStatisticsDay selmStatisticsDay = (SelmStatisticsDay) request.getAttribute(SelmStatisticsDay.SELM_STATISTICS_DAY);
    if (selmStatisticsDay == null)
        selmStatisticsDay = new SelmStatisticsDay(); 
%>
<!DOCTYPE HTML>
<html>
<head>
...
<body>
	<div class="page-container">
		...
		<div class="mt-20">
			<table width="100%"
				class="table table-border table-bordered table-bg table-hover table-sort" id="clientStatDayList">
				<thead>
					<tr class="text-c">
						<th width="15" ><input name="" type="checkbox" ></th>
						<!-- <th width="130">日期</th> -->
						<th width="130">设备</th>
						<th width="130">业务访问量（点击量）</th>
...
<script type="text/javascript">
var table = $('#clientStatDayList').dataTable({
     "aoColumnDefs": [
    ...
    "aoColumns": [
      ...
      "bLengthChange": true ,//改变每页显示数据数量
       "ajax": {
		    url:webRoot+'/statistics/selmClientStatDay/list.do',
		    type:"POST",
		    data: function(d){
		      var stMachineId = $("#searchName").val();
		      d.stMachineId = stMachineId;
		      var stStatisticsId = '<%=selmStatisticsDay.getStStatisticsId()%>';
              d.stStatisticsId = stStatisticsId;
              var stDate = '<%=selmStatisticsDay.stDate2Html()%>';
              d.stDate = stDate;
		    },
		    error:function(){
...
$(function(){
    $("#clientStatDayList").removeAttr("style"); 
});
