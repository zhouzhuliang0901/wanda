...
<body>
	<nav class="breadcrumb">
		...
		统计分析 <span class="c-gray en">&gt;</span>单位统计 <a
...
var table = $('#statisticsDayList').dataTable({
    ...
    "aoColumns": [
                ...
                }},
                {
                 "data": "stName",
                 "render": function (data, type, full, meta) {
                       	var returnInfo = "<a style=\"text-decoration:none\" class=\"ml-5\" onClick=\"group_day('"+full.stName+"->点击量(按天)','/statistics/statistics/deviceaddressDay.do','"+data+"')\" href=\"javascript:;\" title=\"查看\">终端业务统计(按天)</a>";
      ...
      "bLengthChange": false ,//改变每页显示数据数量
       "ajax": {
		    url:webRoot+'/statistics/selmStatistics/addresslist.do',
		    type:"POST",
		    data: function(d){
		     var stAreaId = areaId;
		      d.stAreaId = stAreaId; 
