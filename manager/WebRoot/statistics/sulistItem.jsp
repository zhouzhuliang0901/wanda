...
<body>
	<nav class="breadcrumb">
		...
		统计分析 <span class="c-gray en">&gt;</span>项目统计 <a
...
var table = $('#statisticsDayList').dataTable({
    ...
    "aoColumns": [
                ...
                }},
                {
                 "data": "stStatisticsId",
                 "render": function (data, type, full, meta) {
                        var returnInfo = "<a style=\"text-decoration:none\" class=\"ml-5\" onClick=\"area_day('"+full.stDate+"->业务统计（按天）','/statistics/selmStatistics/areaday.do','"+data+"')\" href=\"javascript:;\" title=\"查看\">终端业务统计(按天)</a>";
                        return returnInfo;
                    },
                  "bSortable": false
                }
      ...
      "bLengthChange": false ,//改变每页显示数据数量
       "ajax": {
		    url:webRoot+'/statistics/statistics/suCountItem.do',
		    type:"POST",
		    data: function(d){
...
// 查看
function area_day(title,url,id){
