...
<body>
	<nav class="breadcrumb">
		...
		统计分析 <span class="c-gray en">&gt;</span>分组统计 <a
	...
	<div class="page-container">
		...
		<div class="text-c" style="text-align: left;">
		    ...
		    <input type="text" name="" id="searchName" placeholder="设备分组" style="width:250px"
				class="input-text">
...
var table = $('#statisticsDayList').dataTable({
    ...
    "aoColumns": [
                ...
                }},
                {
                 "data": "stStatisticsId",
                 "render": function (data, type, full, meta) {
                       	var returnInfo = "<a style=\"text-decoration:none\" class=\"ml-5\" onClick=\"group_day('"+full.stDate+"->点击量(按天)','/statistics/selmStatistics/groupday.do','"+data+"')\" href=\"javascript:;\" title=\"查看\">终端业务统计(按天)</a>";
                        //var returnInfo = "<a style=\"text-decoration:none\" class=\"ml-5\" onClick=\"group_day('"+full.stDate+"->业务统计（按天）','/selmStatistics/groupday.do','"+data+"')\" href=\"javascript:;\" title=\"查看\">终端业务统计(按天)</a>";
                        return returnInfo;
                    },
                  "bSortable": false
                }
      ...
      "bLengthChange": false ,//改变每页显示数据数量
       "ajax": {
		    url:webRoot+'/statistics/statistics/suCountGroup.do',
		    type:"POST",
		    data: function(d){
		     /*  var startDate = $("#startDate").val();
              ...
              d.endDate= endDate; */
               var stGroupName = $("#searchName").val();
...
// 查看
function group_day(title,url,id){
...
function statistics_del(obj,id){
    layer.confirm('确认要删除吗？',function(index){
         $.ajax({
            type : 'POST',
            url : webRoot+'/selmStatisticsDay/remove.do',
            dataType:'json',
