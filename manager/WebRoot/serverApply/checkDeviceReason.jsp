...
<body>
<div style="padding-top: 10px;font-size: 18px;padding-left: 95px;font-weight: 600;margin-bottom: -14px;">不通过的原因</div>
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-4 col-sm-4">
					<textarea rows="10" style="width:250%;height:180px;padding-top:1px;font-size:14px;" type="textarea" class="input-text"
						value=""
						name="stResult" placeholder="小于1000字" required><%=selmDeviceAlink.getStReason()%></textarea>
				</div>
