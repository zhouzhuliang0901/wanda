...
<body>
	<nav class="breadcrumb">
		...
		服务管理<span class="c-gray en">&gt;</span>设备接入申请 <a
	...
	<div class="page-container">
		...
		<div class="cl pd-5 bg-1 bk-gray mt-20">
			<span class="l">
					&nbsp;&nbsp;<a class="btn btn-primary radius" onclick="device_add('设备申请添加','/serverApply/selmDeviceApply/addDeviceApply.do')" href="javascript:;">
                ...
                }},
                {
                 ...
                 "render": function (data, type, full, meta) {
                         if(full.nmStatus==0){
	                            ...
	                            returnInfo += "<a id="+data+"eidt"+" style=\"text-decoration:none; color:blue;\" class=\"ml-5\" onClick=\"serverApply_edit('"+full.stApplyOrganName+"->编辑','/serverApply/selmDeviceApply/edit.do','"+data+"')\" href=\"javascript:;\" title=\"修改申请\"><u>编辑</u>&nbsp;</a>";
	                            returnInfo += "<a style=\"text-decoration:none; color:blue;\" class=\"ml-5\" onClick=\"serverApply_del(this,'"+data+"')\" href=\"javascript:;\" title=\"删除\"><u>删除</u>&nbsp;</a>";
                  		 }else{
