...
<body>
	<nav class="breadcrumb">
		...
		服务管理<span class="c-gray en">&gt;</span>设备变更申请 <a
	...
	<div class="page-container">
		...
		<div class="cl pd-5 bg-1 bk-gray mt-20">
			<span class="l">
					&nbsp;&nbsp;<a class="btn btn-primary radius" onclick="device_add('设备变更','/serverApply/selmDeviceApply/addDeviceChangeApply.do')" href="javascript:;">
                ...
                }},
                {
                 ...
                 "render": function (data, type, full, meta) {
                         if(full.nmStatus==0){
	                            ...
	                            returnInfo += "<a id="+data+"eidt"+" style=\"text-decoration:none;color:blue;\" class=\"ml-5\" onClick=\"serverApply_edit('"+full.stApplyOrganName+"->编辑','/serverApply/deviceChange/selmDeviceApply/edit.do','"+data+"')\" href=\"javascript:;\" title=\"编辑\"><u>编辑</u>&nbsp;</a>";
	                            returnInfo += "<a style=\"text-decoration:none;color:red;\" class=\"ml-5\" onClick=\"serverApply_del(this,'"+data+"')\" href=\"javascript:;\" title=\"删除\"><u>删除</u></a>";
                  				...
                  				var returnInfo = "<a style=\"text-decoration:none;color:blue;\" class=\"ml-5\" onClick=\"serverApply_info('"+full.stApplyOrganName+"->查看','/serverApply/selmDeviceApply/changeInfo.do','"+data+"')\" href=\"javascript:;\" title=\"查看\"><u>查看</u></a>";
	                  		 }
...
function project_del(obj,id){
    layer.confirm('删除选择的所有数据？',function(index){
         $.ajax({
            type : "get",
