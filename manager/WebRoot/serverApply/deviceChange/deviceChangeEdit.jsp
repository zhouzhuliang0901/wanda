    ...
    "aoColumns": [
                ...
                
                {
                 ...
                 "render": function (data, type, full, meta) {
                        ...
                        returnInfo += "<a style=\"text-decoration:none;color:blue;\" class=\"ml-5\" onClick=\"removeDevice('删除设备','/serverApply/selmDeviceAlink/deviceChange/changeRemove.do','"+data+"')\" href=\"javascript:;\" title=\"删除\"><u>删除</u></a>";
                        return returnInfo;
                    },
                  "bSortable": false
                }
