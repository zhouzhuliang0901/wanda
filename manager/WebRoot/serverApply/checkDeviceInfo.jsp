		...
		<form class="form form-horizontal" id="form-device-add">
          ...
          <div class="row cl">
				...
				<div class="formControls col-xs-4 col-sm-4">
					<select type="text" class="input-text">
						<option></option>
						<option>静安区</option>
						<option>黄浦区</option>
						<option>浦东区</option>
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-4 col-sm-4">
					<input name="有" type="checkbox" value="1" >有&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<input name="无" type="checkbox" value="0" >无
				</div>
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-4 col-sm-4">
					<input name="有" type="checkbox" value="1" >政务外网&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<input name="无" type="checkbox" value="0" >互联网
				</div>	
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2">
            ...
            <div class="row cl" style="text-align:center;">
                <div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
                    <button type="submit"
                        class="btn btn-success radius" type="button"> &nbsp;&nbsp;确定&nbsp;&nbsp;
                    </button>
                </div>
            </div>
