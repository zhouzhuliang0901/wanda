		...
		<input type="hidden" name="stDeviceApplyId"
          ...
          <div class="row cl">
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-4 col-sm-4">
					<select type="text" class="input-text" name="ST_PRODUCER">
						<option></option>
						<option value="万达">万达</option>
						<option value="新点">新点</option>
						<option value="卓繁">卓繁</option>
					</select>
				</div>				
				<label class="form-label col-xs-4 col-sm-2">
				<span
				...
				<div class="formControls col-xs-4 col-sm-4">
					<select type="text" class="input-text" name="ST_DEVICETYPE">
						<option></option>
						<option value="政务服务自助终端（卓繁）">政务服务自助终端（卓繁）</option>
						<option value="政务服务自助终端2（万达）">政务服务自助终端2（万达）</option>
						<option value="政务服务自助终端（新点）">政务服务自助终端（新点）</option>
						<option value="政务服务工作台（卓繁）">政务服务工作台（卓繁）</option>
						<option value="政务服务自助终端（万达）">政务服务自助终端（万达）</option>
					</select>
				</div>
			</div>
			<div class="row cl">
				...
				<div class="formControls col-xs-4 col-sm-4">
					<input name="NM_YBZC" type="checkbox" value="1" >有&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<input name="NM_YBZC" type="checkbox" value="0" >无
				</div>
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-4 col-sm-4">
					<input name="NM_GPY" type="checkbox" value="1" >有&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<input name="NM_GPY" type="checkbox" value="0" >无
				</div>	
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2">
				...
				<div class="formControls col-xs-4 col-sm-4">
					<input name="NM_JZZQU" type="checkbox" value="1" >有&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<input name="NM_JZZQU" type="checkbox" value="0" >无
				</div>	
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2">
				...
				<div class="formControls col-xs-4 col-sm-4">
					<input name="NM_JZZZK" type="checkbox" value="1" >有&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<input name="NM_JZZZK" type="checkbox" value="0" >无
				</div>	
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2">
				...
				<div class="formControls col-xs-4 col-sm-4">
					<input name="NM_NETWORK" type="checkbox" value="政务外网" >政务外网&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<input name="NM_NETWORK" type="checkbox" value="互联网" >互联网
				</div>	
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2">
				...
				<div class="formControls col-xs-4 col-sm-4">
					<input name="NM_DUTY" type="checkbox" value="1" >有&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<input name="NM_DUTY" type="checkbox" value="0" >无
				</div>	
			</div>
	...
	function article_save_submit() {
		$.ajax({
			...
			error : function(request) {
				layer.msg("接入申请关联设备保存失败", {
					icon : 1,
					time : 1000
				});
			},
			success : function(data) {
				layer.msg("接入申请关联设备保存成功", {
					icon : 1,
					time : 1000
				});
			}
