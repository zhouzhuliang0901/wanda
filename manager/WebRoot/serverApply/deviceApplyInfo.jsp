    ...
    "aoColumns": [
                ...
                }},
                {
                 ...
                 "render": function (data, type, full, meta) {
                        ...
                        if(full.nmStatus == 3){
                        	returnInfo += "<a style=\"text-decoration:none;color:blue;\" class=\"ml-5\" onClick=\"reason_info('不通过原因','/serverApply/selmDeviceAlink/checkDeviceReason.do','"+data+"')\" href=\"javascript:;\" title=\"查看\"><u>不通过原因</u></a>";
                        }
                        return returnInfo;
                    },
                  "bSortable": false
