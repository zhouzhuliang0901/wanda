...
<body>
<!-- <div style="text-align: center;padding-top: 10px;font-size: 18px;">基本信息</div> -->
...
.dataTable(
		{
			...
			"aoColumns" : [
                 ...
                 if(data == 1 ){
                  ...
                  var returnInfo = "<a id="+full.stLinksId+" style=\"text-decoration:none\" class=\"ml-5\" onClick=\"serverApply_checkItem('/serverApply/selmServerItem/CheckSave.do','"+full.stLinksId+"','1')\" href=\"javascript:;\" title=\"通过\">通过</a>";
                         returnInfo += "<a style=\"text-decoration:none\" class=\"ml-5\"> | </a>"; 
                         returnInfo += "<a id="+full.stLinksId+"noPass"+" style=\"text-decoration:none\" class=\"ml-5\" onClick=\"serverApply_checkItem('/serverApply/selmServerItem/CheckSave.do','"+full.stLinksId+"','0')\" href=\"javascript:;\" title=\"不通过\">不通过</a>";                  
                        return returnInfo;
                	}
                },
                  "bSortable": false
